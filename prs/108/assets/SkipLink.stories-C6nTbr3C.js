...
can still follow the hash.`,methods:[],displayName:"SkipLink",props:{href:{required:!1,tsType:{name:"literal",value:"`#${string}`"},description:"",defaultValue:{value:"'#main'",computed:!1}},children:{defaultValue:{value:"'Skip to main content'",computed:!1},required:!1}}};const v={title:"Accessibility/SkipLink",component:o,argTypes:N,parameters:{controls:{include:["href","children","className"]}}},i={name:"Clavier",parameters:x("import { SkipLink } from 'd-ui';",`<SkipLink>Aller au contenu principal</SkipLink>
<main id="main" tabIndex={-1}>
  Contenu principal
</main>`),render:(e,{globals:r})=>{const n=h(L(r.locale));return a.jsxs("div",{className:"text-fg",children:[a.jsx(o,{...e,children:e.children??n.label}),a.jsx("p",{className:"m-0 text-sm opacity-80",children:n.hint}),a.jsx("main",{id:"main",tabIndex:-1,className:"mt-4 rounded-md border border-border p-4",children:n.main})]})}},t={name:"Cible personnalisée",args:{href:"#content"},parameters:x("import { SkipLink } from 'd-ui';",`<SkipLink href="#content">Aller au contenu</SkipLink>
<main id="content" tabIndex={-1}>
  Zone de contenu
</main>`),render:(e,{globals:r})=>{const n=h(L(r.locale));return a.jsxs("div",{className:"text-fg",children:[a.jsx(o,{...e,children:e.children??n.customLabel}),a.jsx("p",{className:"m-0 text-sm opacity-80",children:n.customHint}),a.jsx("main",{id:"content",tabIndex:-1,className:"mt-4 rounded-md border border-border p-4",children:n.customTarget})]})}};var m,p,u;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  name: 'Clavier',
