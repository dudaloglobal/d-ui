import{r as p,j as n,X as i,d as t}from"./iframe-DSAIdoqD.js";import{j as Le}from"./arg-types-BxKauQRt.js";import{c as u}from"./docs-source-C_O40UCi.js";import{C as Ae}from"./Calendar-DcxAvQ9l.js";import{c as Ie,j as Me,p as $e}from"./calendarDate-jCkUcsyL.js";import{u as Ee}from"./useFieldControl-BHcOyVNb.js";import{P as Ne}from"./Popover-BlcnVuQ3.js";import{T as Oe}from"./TextInput-DcwtnDGc.js";import{p as Re,P as _e,C as Je,f as Ke,a as Be}from"./pickerChrome-DQWj4Apj.js";function o({size:l="md",label:a,helper:e,error:s,invalid:ie=!1,disabled:ue=!1,required:de=!1,fullWidth:me=!0,clearable:pe=!0,name:A,locale:c="fr",placeholder:ye,value:y,defaultValue:I=null,onValueChange:C,minValue:M,maxValue:$,isDateUnavailable:E,today:be,open:N,defaultOpen:fe=!1,onOpenChange:S,openCalendarLabel:O="Ouvrir le calendrier",clearLabel:ge="Effacer",invalidMessage:ve="Date invalide.",className:he}){const P=Ee(),ke=p.useId(),De=P.id??ke,m=!!(ue||P.disabled),[Pe,qe]=p.useState(I),[Te,je]=p.useState(fe),[R,x]=p.useState(()=>L(y??I,c)),[_,q]=p.useState(!1),T=y!==void 0,V=T?y:Pe,Ce=m?!1:N??Te;p.useEffect(()=>{T&&x(L(y,c))},[T,y,c]);function z(r){m&&r||(N===void 0&&je(r),S==null||S(r))}function w(r,j=L(r,c)){T||qe(r),x(j),q(!1),C==null||C(r)}function Se(){const r=Be(R,c);if(r===void 0){q(!0);return}if(r&&$e(r,{minValue:M,maxValue:$,isDateUnavailable:E})){q(!0);return}w(r)}const xe=!!(ie||P["aria-invalid"]||_||s),Ve=ye??(c.toLowerCase().startsWith("en")?"MM/DD/YYYY":"JJ/MM/AAAA"),ze=_?s??ve:s;function we(r){r.key==="ArrowDown"&&r.altKey&&(r.preventDefault(),z(!0))}return n.jsxs(n.Fragment,{children:[A?n.jsx("input",{type:"hidden",name:A,value:V?Ie(V):""}):null,n.jsx(Oe,{id:De,size:l,label:a,helper:e,error:ze,invalid:xe,disabled:m,required:P.required??de,fullWidth:me,clearable:pe,clearLabel:ge,placeholder:Ve,autoComplete:"off",inputMode:"numeric",value:R,className:he,onChange:r=>{x(r.target.value),q(!1)},onBlur:r=>{const j=r.relatedTarget;j instanceof HTMLElement&&j.getAttribute("aria-haspopup")||Se()},onKeyDown:we,onClear:()=>w(null),suffix:n.jsx(Ne,{open:Ce,onOpenChange:z,trapFocus:!0,unstyled:!0,arrow:!1,placement:"bottom-start",disabled:m,"aria-label":O,className:Re,content:n.jsx(Ae,{size:l==="lg"?"md":"sm",locale:c,today:be,value:V,minValue:M,maxValue:$,isDateUnavailable:E,disabled:m,onValueChange:r=>{Me(r)||(w(r),z(!1))}}),children:n.jsx(_e,{label:O,disabled:m,children:n.jsx(Je,{})})})})]})}function L(l,a){return l?Ke(l,a):""}o.__docgenInfo={description:"Champ date : saisie au clavier + Calendar dans un Popover.\n\nValeur civile `{ year, month, day }`, pas de fuseau.",methods:[],displayName:"DatePicker",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},label:{required:!1,tsType:{name:"ReactNode"},description:""},helper:{required:!1,tsType:{name:"ReactNode"},description:""},error:{required:!1,tsType:{name:"ReactNode"},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},required:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},clearable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},name:{required:!1,tsType:{name:"string"},description:""},locale:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'fr'",computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:""},value:{required:!1,tsType:{name:"union",raw:"CalendarDate | null",elements:[{name:"signature",type:"object",raw:`{
...
}`,...(H=(G=g.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var X,Q,Z;v.parameters={...v.parameters,docs:{...(X=v.parameters)==null?void 0:X.docs,source:{originalSource:`{
  name: 'Désactivé',
...
}`,...(Z=(Q=v.parameters)==null?void 0:Q.docs)==null?void 0:Z.source}}};var ee,ae,re;h.parameters={...h.parameters,docs:{...(ee=h.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  name: 'Invalide',
