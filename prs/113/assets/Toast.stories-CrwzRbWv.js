...
<ToastProvider>
  <SaveButton />
</ToastProvider>`),render:(o,{globals:a})=>{const e=y(T(a.locale));function r(){const{toast:t}=C();return n.jsx(u,{type:"button",onClick:()=>t({variant:"success",message:e.saved,dismissible:!0,dismissLabel:e.dismiss}),children:e.show})}return n.jsx(r,{})}},g={name:"Variantes",args:{children:null},parameters:x(D,`toast({ variant: 'info', message: '…' });
toast({ variant: 'success', message: '…' });
toast({ variant: 'warning', message: '…' });
toast({ variant: 'danger', message: '…' });`),render:(o,{globals:a})=>{const e=y(T(a.locale));function r(){const{toast:t}=C();return n.jsxs("div",{className:"flex flex-wrap gap-2",children:[n.jsx(u,{type:"button",onClick:()=>t({variant:"info",message:e.published}),children:e.showInfo}),n.jsx(u,{type:"button",onClick:()=>t({variant:"success",message:e.saved}),children:e.showSuccess}),n.jsx(u,{type:"button",onClick:()=>t({variant:"warning",message:e.warning}),children:e.showWarning}),n.jsx(u,{type:"button",onClick:()=>t({variant:"danger",message:e.danger}),children:e.showDanger})]})}return n.jsx(r,{})}},b={name:"Avec action",args:{children:null},parameters:x(D,`toast({
  variant: 'info',
  message: 'Nouvelle version disponible.',
  actionLabel: 'Voir les détails',
  onActionClick: () => {},
});`),render:(o,{globals:a})=>{const e=y(T(a.locale));function r(){const{toast:t}=C();return n.jsx(u,{type:"button",onClick:()=>t({variant:"info",message:e.callback,actionLabel:e.action,onActionClick:()=>{}}),children:e.show})}return n.jsx(r,{})}},v={name:"Fermable",args:{children:null},parameters:x(D,`toast({
  variant: 'info',
  message: 'Les notes seront publiées demain.',
  dismissible: true,
  dismissLabel: 'Fermer la notification',
  duration: 0,
});`),render:(o,{globals:a})=>{const e=y(T(a.locale));function r(){const{toast:t}=C();return i.useEffect(()=>{t({variant:"info",message:e.published,dismissible:!0,dismissLabel:e.dismiss,duration:0})},[t]),n.jsx(u,{type:"button",onClick:()=>t({variant:"info",message:e.published,dismissible:!0,dismissLabel:e.dismiss,duration:0}),children:e.showDismissible})}return n.jsx(r,{})}},h={name:"File d’attente",args:{children:null,maxVisible:2,defaultDuration:0},parameters:x(D,`<ToastProvider maxVisible={2}>
  …
...
}`,...(R=(F=g.parameters)==null?void 0:F.docs)==null?void 0:R.source}}};var M,I,Q;b.parameters={...b.parameters,docs:{...(M=b.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: 'Avec action',
  args: {
    children: null
  },
...
}`,...(Q=(I=b.parameters)==null?void 0:I.docs)==null?void 0:Q.source}}};var W,O,z;v.parameters={...v.parameters,docs:{...(W=v.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: 'Fermable',
  args: {
    children: null
  },
...
}`,...(z=(O=v.parameters)==null?void 0:O.docs)==null?void 0:z.source}}};var $,G,H;h.parameters={...h.parameters,docs:{...($=h.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: 'File d’attente',
  args: {
    children: null,
    maxVisible: 2,
