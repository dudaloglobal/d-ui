...
import { Icon } from 'd-ui';`,U={title:"Components/Icon",component:a,argTypes:_,args:{as:t}},l={name:"Par défaut",parameters:i(f,"<Icon as={BellIcon} />")},m={name:"Tailles",parameters:i(f,`<>
...
import { Icon } from 'd-ui';`,'<Icon as={TrashIcon} label="Supprimer définitivement" />'),render:(o,{globals:n})=>{const s=G(A(n.locale));return e.jsx(a,{...o,as:g,label:s.deleteForever})}},I={name:"Dans un bouton",parameters:i(`import { ArrowRightIcon, ChevronDownIcon, TrashIcon } from '@heroicons/react/24/outline';
...
</>`),render:(o,{globals:n})=>{const s=G(A(n.locale));return e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(h,{icon:e.jsx(a,{as:W,size:"sm"}),iconPosition:"end",children:s.continue}),e.jsx(h,{variant:"secondary",icon:e.jsx(a,{as:J,size:"sm"}),children:s.filter}),e.jsx(F,{icon:e.jsx(a,{as:g,size:"sm"}),"aria-label":s.delete})]})}};var x,b,v;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(z=(w=m.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};var j,S,y;d.parameters={...d.parameters,docs:{...(j=d.parameters)==null?void 0:j.docs,source:{originalSource:`{
...
}`,...(y=(S=d.parameters)==null?void 0:S.docs)==null?void 0:y.source}}};var C,T,N;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
