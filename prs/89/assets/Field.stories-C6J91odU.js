...
attendre que l'utilisateur revienne sur le champ.`,methods:[],displayName:"FieldError"};function d({className:i,children:n,...r}){const l=q("Label"),a=e.jsxs(e.Fragment,{children:[n,l.required?e.jsx("span",{"aria-hidden":"true",className:"text-danger ml-0.5",children:"*"}):null]}),t=I("text-fg text-sm font-medium",l.disabled?"opacity-50":null,i);return l.group?e.jsx("legend",{...r,id:l.labelId,className:t,children:a}):e.jsx("label",{...r,id:l.labelId,htmlFor:l.controlId,className:t,children:a})}d.__docgenInfo={description:"Libellé du champ.\n\nDans un `Field group`, rend un `legend` : un groupe de contrôles se nomme par\nsa légende. Ailleurs, un `label` lié au contrôle par `for`.\n\nL'astérisque de champ requis est décoratif (`aria-hidden`) : c'est l'attribut\n`required` posé sur le contrôle qui porte l'information pour les lecteurs\nd'écran. Doubler les deux ferait annoncer « requis » deux fois.",methods:[],displayName:"Label"};function ae(){const i=le();return i?i.group?{disabled:i.disabled||void 0}:{id:i.controlId,required:i.required||void 0,disabled:i.disabled||void 0,"aria-invalid":i.invalid||void 0,"aria-describedby":Q(i)}:{}}function L(i){const n=ae();return e.jsx("input",{...n,...i,className:"text-fg bg-field hover:bg-field-hover h-9 w-full min-w-0 rounded px-3 text-sm ring-1 ring-inset ring-fg/40 focus:bg-transparent focus:ring-2 focus:ring-focus focus:outline-none disabled:pointer-events-none disabled:opacity-50 aria-invalid:ring-2 aria-invalid:ring-danger"})}const f="import { Field, FieldDescription, FieldError, Label } from 'd-ui';",se={title:"Components/Field",component:o,argTypes:ne,args:{children:null}},F={name:"Par défaut",parameters:p(f,`<Field>
  <Label>Adresse e-mail</Label>
  <input type="email" />
</Field>`),render:(i,{globals:n})=>{const r=c(u(n.locale));return e.jsxs(o,{children:[e.jsx(d,{children:r.email}),e.jsx(L,{type:"email",defaultValue:r.emailValue})]})}},x={name:"Avec aide",parameters:p(f,`<Field>
  <Label>Adresse e-mail</Label>
  <FieldDescription>Elle sert à la récupération de compte.</FieldDescription>
  <input type="email" />
</Field>`),render:(i,{globals:n})=>{const r=c(u(n.locale));return e.jsxs(o,{children:[e.jsx(d,{children:r.email}),e.jsx(m,{children:r.emailHelp}),e.jsx(L,{type:"email"})]})}},y={name:"Requis",parameters:p(f,`<Field required>
  <Label>Nom du parcours</Label>
  <FieldDescription>Visible par les étudiants inscrits.</FieldDescription>
  <input />
</Field>`),render:(i,{globals:n})=>{const r=c(u(n.locale));return e.jsxs(o,{required:!0,children:[e.jsx(d,{children:r.pathName}),e.jsx(m,{children:r.pathHelp}),e.jsx(L,{})]})}},g={name:"Invalide",parameters:p(f,`<Field invalid required>
  <Label>Adresse e-mail</Label>
  <FieldDescription>Elle sert à la récupération de compte.</FieldDescription>
  <input type="email" defaultValue="etudiant@" />
  <FieldError>Cette adresse n’est pas valide.</FieldError>
</Field>`),render:(i,{globals:n})=>{const r=c(u(n.locale));return e.jsxs(o,{invalid:!0,required:!0,children:[e.jsx(d,{children:r.email}),e.jsx(m,{children:r.emailHelp}),e.jsx(L,{type:"email",defaultValue:r.emailInvalid}),e.jsx(Z,{children:r.emailError})]})}},h={name:"Désactivé",parameters:p(f,`<Field disabled>
  <Label>Identifiant</Label>
  <FieldDescription>Attribué par l’établissement.</FieldDescription>
  <input defaultValue="DUD-2026-0142" />
</Field>`),render:(i,{globals:n})=>{const r=c(u(n.locale));return e.jsxs(o,{disabled:!0,children:[e.jsx(d,{children:r.identifier}),e.jsx(m,{children:r.identifierHelp}),e.jsx(L,{defaultValue:r.identifierValue})]})}},D={name:"Groupe",parameters:p(f,`<Field group required>
  <Label>Notifications</Label>
  <FieldDescription>Choisissez au moins un canal.</FieldDescription>
  <label>
    <input type="checkbox" /> E-mail
  </label>
</Field>`),render:(i,{globals:n})=>{const r=c(u(n.locale));return e.jsxs(o,{group:!0,required:!0,children:[e.jsx(d,{children:r.notifications}),e.jsx(m,{children:r.notificationsHelp}),e.jsxs("div",{className:"flex flex-col gap-2 pt-1",children:[e.jsxs("label",{className:"text-fg flex items-center gap-2 text-sm",children:[e.jsx("input",{type:"checkbox",defaultChecked:!0})," ",r.channelEmail]}),e.jsxs("label",{className:"text-fg flex items-center gap-2 text-sm",children:[e.jsx("input",{type:"checkbox"})," ",r.channelSms]})]})]})}};var V,A,H;F.parameters={...F.parameters,docs:{...(V=F.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(k=(R=x.parameters)==null?void 0:R.docs)==null?void 0:k.source}}};var w,G,O;y.parameters={...y.parameters,docs:{...(w=y.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Requis',
...
}`,...(O=(G=y.parameters)==null?void 0:G.docs)==null?void 0:O.source}}};var P,z,M;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'Invalide',
...
}`,...(M=(z=g.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};var $,W,B;h.parameters={...h.parameters,docs:{...($=h.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: 'Désactivé',
...
}`,...(B=(W=h.parameters)==null?void 0:W.docs)==null?void 0:B.source}}};var U,X,J;D.parameters={...D.parameters,docs:{...(U=D.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'Groupe',
...
}`,...(J=(X=D.parameters)==null?void 0:X.docs)==null?void 0:J.source}}};const te=["Default","WithDescription","Required","Invalid","Disabled","Group"],ue=Object.freeze(Object.defineProperty({__proto__:null,Default:F,Disabled:h,Group:D,Invalid:g,Required:y,WithDescription:x,__namedExportsOrder:te,default:se},Symbol.toStringTag,{value:"Module"}));export{F as D,ue as F,D as G,g as I,y as R,x as W,h as a};
