...
/>`),render:(e,{globals:a})=>{const t=b(a.locale);return n.jsx(m,{...e,locale:e.locale??t})}},E={name:"Dates restreintes",parameters:v(k,`<Calendar
    ...
    locale="fr"
    weekStartsOn={1}
/>`),args:{minValue:{year:2026,month:3,day:5},maxValue:{year:2026,month:3,day:25},isDateUnavailable:e=>e.day===13},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},Y={name:"Début de semaine",parameters:v(k,`<>
...
</>`),render:(e,{globals:a})=>{const t=be(b(a.locale));return n.jsxs("div",{className:"flex flex-wrap gap-8",children:[n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:t.weekMonday}),n.jsx(m,{today:q,defaultValue:T,defaultMonth:O,locale:"fr",weekStartsOn:1})]}),n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:t.weekSunday}),n.jsx(m,{today:q,defaultValue:T,defaultMonth:O,locale:"en",weekStartsOn:0})]})]})}},B={name:"Langue",parameters:v(k,`<>
...
</>`),render:(e,{globals:a})=>{const t=be(b(a.locale));return n.jsxs("div",{className:"flex flex-wrap gap-8",children:[n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:t.french}),n.jsx(m,{today:q,defaultValue:T,defaultMonth:O,locale:"fr",weekStartsOn:1})]}),n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:t.english}),n.jsx(m,{today:q,defaultValue:T,defaultMonth:O,locale:"en",weekStartsOn:0})]})]})}},K={name:"Plusieurs mois",parameters:v(k,`<Calendar
    numberOfMonths={2}
    defaultValue={{ year: 2026, month: 3, day: 12 }}
    today={{ year: 2026, month: 3, day: 18 }}
    locale="fr"
    weekStartsOn={1}
/>`),args:{numberOfMonths:2},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},Z={name:"Tailles",parameters:v(k,`<>
...
</>`),render:(e,{globals:a})=>{const t=b(a.locale),o=be(t);return n.jsxs("div",{className:"flex flex-col gap-8",children:[n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:o.small}),n.jsx(m,{size:"sm",today:q,defaultValue:T,defaultMonth:O,locale:t,weekStartsOn:1})]}),n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:o.medium}),n.jsx(m,{size:"md",today:q,defaultValue:T,defaultMonth:O,locale:t,weekStartsOn:1})]}),n.jsxs("div",{children:[n.jsx("p",{className:"mb-2 font-sans text-sm text-fg",children:o.large}),n.jsx(m,{size:"lg",today:q,defaultValue:T,defaultMonth:O,locale:t,weekStartsOn:1})]})]})}},$={name:"Désactivé",parameters:v(k,"<Calendar disabled defaultValue={{ year: 2026, month: 3, day: 12 }} />"),args:{disabled:!0},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},G={name:"Week-ends indisponibles",parameters:v(k,`<Calendar
    ...
    defaultValue={{ year: 2026, month: 3, day: 12 }}
    locale="fr"
/>`),args:{isDateUnavailable:fn},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},H={name:"Année",parameters:v(k,`<Calendar
    defaultMonth={{ year: 2026, month: 3, day: 1 }}
    minValue={{ year: 2020, month: 1, day: 1 }}
    maxValue={{ year: 2030, month: 12, day: 31 }}
    locale="fr"
/>`),args:{minValue:{year:2020,month:1,day:1},maxValue:{year:2030,month:12,day:31}},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},Q={name:"Plage de dates",parameters:v(k,`<Calendar
    selectionMode="range"
    numberOfMonths={2}
    defaultValue={{
    ...
    locale="fr"
/>`),args:{selectionMode:"range",numberOfMonths:2,defaultValue:{start:{year:2026,month:3,day:25},end:{year:2026,month:4,day:8}}},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})};var Re,ze,Pe;F.parameters={...F.parameters,docs:{...(Re=F.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(He=(Ge=K.parameters)==null?void 0:Ge.docs)==null?void 0:He.source}}};var Qe,Je,Xe;Z.parameters={...Z.parameters,docs:{...(Qe=Z.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  name: 'Tailles',
  parameters: componentSource(importCalendar, \`<>
    <Calendar size="sm" defaultMonth={{ year: 2026, month: 3, day: 1 }} />
    <Calendar size="md" defaultMonth={{ year: 2026, month: 3, day: 1 }} />
...
}`,...(Xe=(Je=Z.parameters)==null?void 0:Je.docs)==null?void 0:Xe.source}}};var ea,aa,na;$.parameters={...$.parameters,docs:{...(ea=$.parameters)==null?void 0:ea.docs,source:{originalSource:`{
  name: 'Désactivé',
...
}`,...(ua=(sa=H.parameters)==null?void 0:sa.docs)==null?void 0:ua.source}}};var da,ia,ma;Q.parameters={...Q.parameters,docs:{...(da=Q.parameters)==null?void 0:da.docs,source:{originalSource:`{
  name: 'Plage de dates',
  parameters: componentSource(importCalendar, \`<Calendar
    selectionMode="range"
    numberOfMonths={2}
...
}`,...(ma=(ia=Q.parameters)==null?void 0:ia.docs)==null?void 0:ma.source}}};const hn=["Default","Restricted","WeekStart","Locale","MultipleMonths","Sizes","Disabled","WeekendsUnavailable","Year","Range"],wn=Object.freeze(Object.defineProperty({__proto__:null,Default:F,Disabled:$,Locale:B,MultipleMonths:K,Range:Q,Restricted:E,Sizes:Z,WeekStart:Y,WeekendsUnavailable:G,Year:H,__namedExportsOrder:hn,default:pn},Symbol.toStringTag,{value:"Module"}));export{wn as C,F as D,B as L,K as M,E as R,Z as S,G as W,H as Y,Q as a,Y as b,$ as c};
