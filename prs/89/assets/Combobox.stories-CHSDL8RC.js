...
/>`),render:(e,{globals:n})=>{const o=y(x(n.locale));return a.jsx(Ve,{...e,label:e.label??o.city,placeholder:o.search,...d(o),options:S(o)})}},J={name:"Sélection multiple",args:{options:[]},parameters:qe(`<Combobox
    multiple
    label="Villes"
    placeholder="Rechercher"
    options={options}
...
/>`),render:(e,{globals:n})=>{const o=y(x(n.locale));return a.jsx(p,{label:o.city,options:Qa(o),placeholder:o.search,...d(o)})}};function Za({copy:e}){const[n,o]=v.useState(["lyon"]),[s,t]=v.useState(""),[c,u]=v.useState(Xa(e)),m=s.trim(),i=m.length>0&&!me(c).some(l=>String(l.label).toLowerCase()===m.toLowerCase()),q=()=>{const l={value:m.toLowerCase(),label:m,description:e.customCity};u(j=>[...j,l]),o(j=>[...j,l.value]),t("")};return a.jsx(p,{multiple:!0,label:e.cities,placeholder:e.search,options:c,value:n,onValueChange:l=>o(Array.isArray(l)?l:[l]),onSearch:t,filter:"auto",...d(e),renderOption:l=>a.jsxs("span",{className:"flex min-w-0 items-center gap-2",children:[a.jsx(eo,{name:l.value}),a.jsxs("span",{className:"min-w-0",children:[a.jsx("span",{className:"block truncate font-medium",children:l.label}),l.description?a.jsx("span",{className:"mt-0.5 block truncate text-xs font-normal text-fg/60",children:l.description}):null]})]}),renderSectionTitle:l=>a.jsx("span",{className:"uppercase tracking-wide",children:l.label}),renderChip:l=>a.jsxs("span",{className:"inline-flex min-w-0 items-center gap-1.5",children:[a.jsx(eo,{name:l.value}),a.jsx("span",{className:"truncate",children:l.label})]}),beforeOptions:i?a.jsxs("button",{type:"button",className:"flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-fg hover:bg-surface-hover",onMouseDown:l=>l.preventDefault(),onClick:q,children:[a.jsx(Ya,{}),e.create," « ",m," »"]}):null})}const le={name:"Rendu personnalisé",args:{options:[]},parameters:qe(`<Combobox
    multiple
    label="Villes"
    options={options}
    renderOption={(option) => (
...
}`,...(no=(ao=Y.parameters)==null?void 0:ao.docs)==null?void 0:no.source}}};var ro,to,so;J.parameters={...J.parameters,docs:{...(ro=J.parameters)==null?void 0:ro.docs,source:{originalSource:`{
...
}`,...(so=(to=J.parameters)==null?void 0:to.docs)==null?void 0:so.source}}};var lo,io,co;Z.parameters={...Z.parameters,docs:{...(lo=Z.parameters)==null?void 0:lo.docs,source:{originalSource:`{
  name: 'Désactivé',
  args: {
    options: []
  },
...
}`,...(Eo=(Do=ie.parameters)==null?void 0:Do.docs)==null?void 0:Eo.source}}};var $o,Ao,zo;ce.parameters={...ce.parameters,docs:{...($o=ce.parameters)==null?void 0:$o.docs,source:{originalSource:`{
...
}`,...(zo=(Ao=ce.parameters)==null?void 0:Ao.docs)==null?void 0:zo.source}}};var Po,Bo,Fo;ue.parameters={...ue.parameters,docs:{...(Po=ue.parameters)==null?void 0:Po.docs,source:{originalSource:`{
  name: 'État vide',
  args: {
    options: []
  },
...
}`,...(Uo=(Qo=de.parameters)==null?void 0:Qo.docs)==null?void 0:Uo.source}}};const en=["Default","Multiple","Disabled","Invalid","Required","Helper","Valid","Sizes","Group","Descriptions","Custom","Loading","LoadingMore","Empty","ListError","FilterTypes"],ln=Object.freeze(Object.defineProperty({__proto__:null,Custom:le,Default:Y,Descriptions:se,Disabled:Z,Empty:ue,FilterTypes:de,Group:te,Helper:ae,Invalid:ee,ListError:pe,Loading:ie,LoadingMore:ce,Multiple:J,Required:oe,Sizes:re,Valid:ne,__namedExportsOrder:en,default:Ja},Symbol.toStringTag,{value:"Module"}));export{ln as C,Y as D,ue as E,de as F,te as G,ae as H,ee as I,ie as L,J as M,oe as R,re as S,ne as V,se as a,le as b,Z as c,ce as d,pe as e};
