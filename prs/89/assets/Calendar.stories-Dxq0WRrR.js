...
/>`),args:{isDateUnavailable:fn},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},H={name:"Année",parameters:v(k,`<Calendar
    ...
    locale="fr"
/>`),args:{minValue:{year:2020,month:1,day:1},maxValue:{year:2030,month:12,day:31}},render:(e,{globals:a})=>n.jsx(m,{...e,locale:e.locale??b(a.locale)})},J={name:"Plage de dates",parameters:v(k,`<Calendar
    selectionMode="range"
    numberOfMonths={2}
    defaultValue={{
...
}`,...(Pe=(ze=F.parameters)==null?void 0:ze.docs)==null?void 0:Pe.source}}};var We,_e,Ae;E.parameters={...E.parameters,docs:{...(We=E.parameters)==null?void 0:We.docs,source:{originalSource:`{
...
}`,...(Ae=(_e=E.parameters)==null?void 0:_e.docs)==null?void 0:Ae.source}}};var Fe,Ee,Ye;Y.parameters={...Y.parameters,docs:{...(Fe=Y.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
...
}`,...(ma=(ia=J.parameters)==null?void 0:ia.docs)==null?void 0:ma.source}}};const hn=["Default","Restricted","WeekStart","Locale","MultipleMonths","Sizes","Disabled","WeekendsUnavailable","Year","Range"],Cn=Object.freeze(Object.defineProperty({__proto__:null,Default:F,Disabled:$,Locale:B,MultipleMonths:K,Range:J,Restricted:E,Sizes:Z,WeekStart:Y,WeekendsUnavailable:G,Year:H,__namedExportsOrder:hn,default:pn},Symbol.toStringTag,{value:"Module"}));export{Cn as C,F as D,B as L,K as M,E as R,Z as S,G as W,H as Y,J as a,Y as b,$ as c};
