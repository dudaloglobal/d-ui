...
`).map(e=>`    ${e}`).join(`
`)}
);`)}function r({defaultValue:t,value:a,onChange:e,...M}){const[P,w]=d.useState(()=>H(a??t));return l.jsx(A,{...M,value:P,onChange:u=>{w(u.target.value),e==null||e(u)}})}const ja={title:"Components/TextInput",component:A,argTypes:fa,parameters:{controls:{include:["type","size","label","helper","placeholder","invalid","valid","disabled","required","clearable","showCount","fullWidth","focusShadow","maxLength"]}}},i={name:"Par défaut",parameters:o(`<TextInput
...
}`,...($e=(Ne=I.parameters)==null?void 0:Ne.docs)==null?void 0:$e.source}}};var ze,Re,De;T.parameters={...T.parameters,docs:{...(ze=T.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  name: 'Tailles',
...
}`,...(De=(Re=T.parameters)==null?void 0:Re.docs)==null?void 0:De.source}}};var Ee,He,Ae;C.parameters={...C.parameters,docs:{...(Ee=C.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  name: 'Halo de focus',
  parameters: textInputSource(\`<TextInput
    label="Libellé du champ"
    value={value}
...
}`,...(Ae=(He=C.parameters)==null?void 0:He.docs)==null?void 0:Ae.source}}};var Fe,Be,ke;V.parameters={...V.parameters,docs:{...(Fe=V.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  name: 'Nombre',
  parameters: textInputSource(\`<TextInput
    type="number"
    inputMode="numeric"
