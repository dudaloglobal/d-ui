...
import { Textarea } from 'd-ui';`;function De(l){return(a,e)=>l.countRemaining(Math.max(0,(e??0)-a))}function o(l,a=""){return Se(ze,`const [value, setValue] = useState(${JSON.stringify(a)});
return (
${l.trim().split(`
`).map(e=>`    ${e}`).join(`
`)}
);`)}function u({defaultValue:l,value:a,onChange:e,...L}){const[b,i]=y.useState(()=>q(a??l));return t.jsx(M,{...L,value:b,onChange:x=>{i(x.target.value),e==null||e(x)}})}const Re={title:"Components/Textarea",component:M,argTypes:Ce,parameters:{controls:{include:["size","label","helper","placeholder","invalid","valid","disabled","required","clearable","showCount","fullWidth","focusShadow","maxLength","rows"]}}},c={name:"Par défaut",parameters:o(`<Textarea
...
}`,...(J=(W=c.parameters)==null?void 0:W.docs)==null?void 0:J.source}}};var U,G,K;d.parameters={...d.parameters,docs:{...(U=d.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'Désactivé',
  parameters: textareaSource(\`<Textarea
    label="Libellé de la zone de texte"
    value={value}
...
}`,...(K=(G=d.parameters)==null?void 0:G.docs)==null?void 0:K.source}}};var Q,X,Y;m.parameters={...m.parameters,docs:{...(Q=m.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: 'Valide',
  parameters: textareaSource(\`<Textarea
    label="Libellé de la zone de texte"
    value={value}
...
}`,...(oe=(se=f.parameters)==null?void 0:se.docs)==null?void 0:oe.source}}};const $e=["Default","Disabled","Valid","Invalid","MaxLength","FocusShadow"],He=Object.freeze(Object.defineProperty({__proto__:null,Default:c,Disabled:d,FocusShadow:f,Invalid:p,MaxLength:v,Valid:m,__namedExportsOrder:$e,default:Re},Symbol.toStringTag,{value:"Module"}));export{c as D,f as F,p as I,v as M,He as T,m as V,d as a};
