import{T as s,g as l,d as p,j as e}from"./iframe-DwQTNPAe.js";import{f as y,c as f}from"./docs-source-Dhouib-y.js";import{B as h}from"./Button-DGDiVxoB.js";const B={title:"Foundations/ThemeProvider",component:s,args:{children:null},argTypes:y,parameters:{controls:{include:["mode","className"]}}},r={name:"Surcharge de marque",parameters:f("import { Button, ThemeProvider } from 'd-ui';",`<ThemeProvider
  tokens={{
    brand: '#7c3aed',
    brandHover: '#6d28d9',
    onBrand: '#ffffff',
...
}`,...(u=(i=o.parameters)==null?void 0:i.docs)==null?void 0:u.source}}};const T=["BrandOverride","System"],x=Object.freeze(Object.defineProperty({__proto__:null,BrandOverride:r,System:o,__namedExportsOrder:T,default:B},Symbol.toStringTag,{value:"Module"}));export{r as B,o as S,x as T};
