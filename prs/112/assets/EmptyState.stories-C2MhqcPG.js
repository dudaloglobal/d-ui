...
/>`),render:(o,{globals:n})=>{const e=f(S(n.locale));return t.jsx(c,{...o,title:e.coursesTitle,description:e.coursesDescription,icon:t.jsx(B,{as:x,size:"lg"}),actions:t.jsxs(t.Fragment,{children:[t.jsx(p,{children:e.primary}),t.jsx(p,{variant:"secondary",children:e.secondary})]})})}};var u,m,d;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(g=(y=a.parameters)==null?void 0:y.docs)==null?void 0:g.source}}};const C=["Default","WithActions"],N=Object.freeze(Object.defineProperty({__proto__:null,Default:r,WithActions:a,__namedExportsOrder:C,default:A},Symbol.toStringTag,{value:"Module"}));export{r as D,N as E,a as W};
