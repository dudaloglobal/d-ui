...
import { Button, Icon, Menu, MenuItem, MenuSeparator } from 'd-ui';`,Un="import { Button, ContextMenu, Menu, MenuItem, MenuSeparator } from 'd-ui';",Yn={title:"Components/Menu",component:l,argTypes:cn,args:{trigger:e.jsx("span",{}),children:e.jsx("span",{})}},E={name:"Par défaut",parameters:h(q,`<Menu label="Actions du devoir" trigger={<Button variant="secondary">Actions</Button>}>
    <MenuItem>Renommer</MenuItem>
    <MenuItem>Dupliquer</MenuItem>
    <MenuSeparator />
    <MenuItem>Supprimer</MenuItem>
</Menu>`),render:(t,{globals:r})=>{const n=b(y(r.locale));return e.jsxs(l,{...t,label:n.label,trigger:e.jsx(M,{variant:"secondary",children:n.actions}),children:[e.jsx(o,{children:n.rename}),e.jsx(o,{children:n.duplicate}),e.jsx(A,{}),e.jsx(o,{children:n.delete})]})}},L={name:"Variantes de déclencheur",parameters:h(Wn,`<>
    <Menu
...
</Menu>`),render:(t,{globals:r})=>{const n=b(y(r.locale));return e.jsxs(l,{...t,label:n.label,trigger:e.jsx(M,{variant:"secondary",children:n.actions}),children:[e.jsx(o,{icon:e.jsx(C,{as:Vn}),children:n.rename}),e.jsx(o,{icon:e.jsx(C,{as:Fn}),shortcut:n.duplicateShortcut,children:n.duplicate}),e.jsx(o,{href:"/devoirs/12",iconEnd:e.jsx(C,{as:En}),children:n.openAssignment}),e.jsx(A,{}),e.jsx(o,{icon:e.jsx(C,{as:Ln}),children:n.delete})]})}},z={name:"Raccourcis",parameters:h(q,`<Menu label="Actions du devoir" trigger={<Button variant="secondary">Actions</Button>}>
    ...
    <MenuItem>Renommer</MenuItem>
</Menu>`),render:(t,{globals:r})=>{const n=b(y(r.locale));return e.jsx(l,{...t,disabled:!0,label:n.label,trigger:e.jsx(M,{variant:"secondary",children:n.actions}),children:e.jsx(o,{children:n.rename})})}};var de,pe,Me;E.parameters={...E.parameters,docs:{...(de=E.parameters)==null?void 0:de.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(Me=(pe=E.parameters)==null?void 0:pe.docs)==null?void 0:Me.source}}};var Ie,ge,fe;L.parameters={...L.parameters,docs:{...(Ie=L.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
...
}`,...(fe=(ge=L.parameters)==null?void 0:ge.docs)==null?void 0:fe.source}}};var be,ye,he;P.parameters={...P.parameters,docs:{...(be=P.parameters)==null?void 0:be.docs,source:{originalSource:`{
...
}`,...(qe=(Ce=_.parameters)==null?void 0:Ce.docs)==null?void 0:qe.source}}};var Ne,ke,Ee;$.parameters={...$.parameters,docs:{...(Ne=$.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  name: 'Tailles',
...
}`,...(Ee=(ke=$.parameters)==null?void 0:ke.docs)==null?void 0:Ee.source}}};var Le,Pe,ze;V.parameters={...V.parameters,docs:{...(Le=V.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  name: 'Désactivé',
...
}`,...(ze=(Pe=V.parameters)==null?void 0:Pe.docs)==null?void 0:ze.source}}};const Gn=["Default","TriggerVariants","Items","Shortcuts","DisabledItems","Submenu","Context","Sizes","Disabled"],ut=Object.freeze(Object.defineProperty({__proto__:null,Context:_,Default:E,Disabled:V,DisabledItems:F,Items:P,Shortcuts:z,Sizes:$,Submenu:O,TriggerVariants:L,__namedExportsOrder:Gn,default:Yn},Symbol.toStringTag,{value:"Module"}));export{_ as C,E as D,P as I,ut as M,z as S,L as T,F as a,O as b,$ as c,V as d};
