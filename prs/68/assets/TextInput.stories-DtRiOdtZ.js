...
import { TextInput } from 'd-ui';`;function wa(t){return(a,e)=>t.countRemaining(Math.max(0,(e??0)-a))}function o(t,a=""){return Je(Ke,`const [value, setValue] = useState(${JSON.stringify(a)});
return (
${t.trim().split(`
`).map(e=>`    ${e}`).join(`
`)}
);`)}function r({defaultValue:t,value:a,onChange:e,...M}){const[P,w]=d.useState(()=>A(a??t));return l.jsx(F,{...M,value:P,onChange:u=>{w(u.target.value),e==null||e(u)}})}const ja={title:"Components/TextInput",component:F,argTypes:va,parameters:{controls:{include:["type","size","label","helper","placeholder","invalid","valid","disabled","required","clearable","showCount","fullWidth","focusShadow","maxLength"]}}},i={name:"Par défaut",parameters:o(`<TextInput
...
/>`,"Valeur"),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,defaultValue:e.filledValue,disabled:!0})}},b={name:"Valide",parameters:o(`<TextInput
    ...
    valid
    onChange={(event) => setValue(event.target.value)}
/>`,"Valeur"),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,defaultValue:e.filledValue,valid:!0})}},f={name:"Invalide",parameters:o(`<TextInput
    label="Libellé du champ"
    value={value}
    invalid
    error="Valeur invalide"
    onChange={(event) => setValue(event.target.value)}
/>`,"Valeur"),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,defaultValue:e.filledValue,invalid:!0,error:e.invalidValue})}},v={name:"Requis",parameters:o(`<TextInput
    label="Libellé du champ"
    value={value}
    required
    onChange={(event) => setValue(event.target.value)}
...
/>`),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,helper:e.helper})}},g={name:"Texte de substitution",parameters:o(`<TextInput
    ...
    value={value}
    onChange={(event) => setValue(event.target.value)}
/>`),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,placeholder:e.placeholder})}},h={name:"Icône",parameters:Je(Ke,`${xa}
...
}`,...(pe=(ce=b.parameters)==null?void 0:ce.docs)==null?void 0:pe.source}}};var de,ie,me;f.parameters={...f.parameters,docs:{...(de=f.parameters)==null?void 0:de.docs,source:{originalSource:`{
  name: 'Invalide',
  parameters: textInputSource(\`<TextInput
    label="Libellé du champ"
    value={value}
...
}`,...(me=(ie=f.parameters)==null?void 0:ie.docs)==null?void 0:me.source}}};var be,fe,ve;v.parameters={...v.parameters,docs:{...(be=v.parameters)==null?void 0:be.docs,source:{originalSource:`{
  name: 'Requis',
  parameters: textInputSource(\`<TextInput
    label="Libellé du champ"
    value={value}
...
}`,...(ve=(fe=v.parameters)==null?void 0:fe.docs)==null?void 0:ve.source}}};var xe,ge,he;x.parameters={...x.parameters,docs:{...(xe=x.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  name: 'Aide',
  parameters: textInputSource(\`<TextInput
    label="Libellé du champ"
    helper="Texte d’aide"
...
}`,...(je=(we=y.parameters)==null?void 0:we.docs)==null?void 0:je.source}}};var _e,qe,Me;L.parameters={...L.parameters,docs:{...(_e=L.parameters)==null?void 0:_e.docs,source:{originalSource:`{
...
}`,...(Me=(qe=L.parameters)==null?void 0:qe.docs)==null?void 0:Me.source}}};var Pe,Ne,$e;I.parameters={...I.parameters,docs:{...(Pe=I.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
...
}`,...(Fe=(Ae=C.parameters)==null?void 0:Ae.docs)==null?void 0:Fe.source}}};var He,ke,Be;V.parameters={...V.parameters,docs:{...(He=V.parameters)==null?void 0:He.docs,source:{originalSource:`{
  name: 'Nombre',
  parameters: textInputSource(\`<TextInput
    type="number"
    inputMode="numeric"
...
}`,...(Be=(ke=V.parameters)==null?void 0:ke.docs)==null?void 0:Be.source}}};var Oe,Ue,We;S.parameters={...S.parameters,docs:{...(Oe=S.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  name: 'Mot de passe',
  parameters: textInputSource(\`<TextInput
    type="password"
    autoComplete="current-password"
...
}`,...(We=(Ue=S.parameters)==null?void 0:Ue.docs)==null?void 0:We.source}}};const _a=["Default","Disabled","Valid","Invalid","Required","Helper","Placeholder","Icon","Clearable","MaxLength","PrefixSuffix","Sizes","FocusShadow","Number","Password"],za=Object.freeze(Object.defineProperty({__proto__:null,Clearable:y,Default:i,Disabled:m,FocusShadow:C,Helper:x,Icon:h,Invalid:f,MaxLength:L,Number:V,Password:S,Placeholder:g,PrefixSuffix:I,Required:v,Sizes:T,Valid:b,__namedExportsOrder:_a,default:ja},Symbol.toStringTag,{value:"Module"}));export{y as C,i as D,C as F,x as H,f as I,L as M,V as N,g as P,v as R,T as S,za as T,b as V,m as a,h as b,I as c,S as d};
