...
/>`),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,helper:e.helper})}},g={name:"Texte de substitution",parameters:o(`<TextInput
    ...
    value={value}
    onChange={(event) => setValue(event.target.value)}
/>`),render:(t,{globals:a})=>{const e=n(s(a.locale));return l.jsx(r,{label:e.fieldLabel,placeholder:e.placeholder})}},h={name:"Icône",parameters:Je(Ge,`${xa}
