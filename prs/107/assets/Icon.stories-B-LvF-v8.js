...
</>`),render:(r,{globals:o})=>{const a=D(_(o.locale));return e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(h,{icon:e.jsx(s,{as:W,size:"sm"}),iconPosition:"end",children:a.continue}),e.jsx(h,{variant:"secondary",icon:e.jsx(s,{as:q,size:"sm"}),children:a.filter}),e.jsx(F,{icon:e.jsx(s,{as:g,size:"sm"}),"aria-label":a.delete})]})}};var x,B,b;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(E=(k=u.parameters)==null?void 0:k.docs)==null?void 0:E.source}}};var R,O,A;I.parameters={...I.parameters,docs:{...(R=I.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'Dans un bouton',
