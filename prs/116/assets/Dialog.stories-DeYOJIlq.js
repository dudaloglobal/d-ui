...
</AlertDialog>`),render:(t,{globals:i})=>e.jsx(Ca,{copy:f(D(i.locale))})},X={name:"Pied de page fixe",args:y,parameters:h(T,`<Dialog open={open} onOpenChange={setOpen}>
...
</Dialog>`),render:(t,{globals:i})=>e.jsx(ja,{copy:f(D(i.locale))})},re={name:"Bordure et coins",args:y,parameters:h(T,`<Dialog open={open} onOpenChange={setOpen} bordered radius="xl">
...
}`,...(Tn=(bn=ce.parameters)==null?void 0:bn.docs)==null?void 0:Tn.source}}};const Aa=["Default","ConfirmDialog","AlertKinds","TintedFooter","CenteredSingleAction","CenteredWideButtons","Alert","WithDismissButton","AlertLeftAligned","Sizes","Processing","PanelChrome","Scrollable","Animation","WithForm"],Ka=Object.freeze(Object.defineProperty({__proto__:null,Alert:ne,AlertKinds:Z,AlertLeftAligned:ie,Animation:le,CenteredSingleAction:Y,CenteredWideButtons:ee,ConfirmDialog:J,Default:G,PanelChrome:re,Processing:te,Scrollable:se,Sizes:oe,TintedFooter:X,WithDismissButton:ae,WithForm:ce,__namedExportsOrder:Aa,default:Ta},Symbol.toStringTag,{value:"Module"}));export{Z as A,J as C,Ka as D,te as P,se as S,X as T,ae as W,G as a,Y as b,ee as c,ne as d,ie as e,ce as f,oe as g,re as h,le as i};
