...
<TimePicker size="lg" label="Heure de début" />`),render:(l,{globals:n})=>{const a=v(k(n.locale));return r.jsxs("div",{className:"flex flex-col gap-4",children:[r.jsx(t,{...l,size:"sm",label:`${a.label} (${a.small})`}),r.jsx(t,{...l,size:"md",label:`${a.label} (${a.medium})`}),r.jsx(t,{...l,size:"lg",label:`${a.label} (${a.large})`})]})}};var E,O,M;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(M=(O=o.parameters)==null?void 0:O.docs)==null?void 0:M.source}}};var _,A,B;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: 'Désactivé',
