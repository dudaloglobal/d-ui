...
</div>`),render:(t,{globals:a})=>{const r=c(i(a.locale)),n=[{key:"default",label:r.wrapDefault,props:{}},{key:"nowrap",label:r.wrapNoWrap,props:{noWrap:!0}},{key:"truncate",label:r.wrapTruncate,props:{truncate:!0}},{key:"multiline",label:r.wrapTruncateMultiline,props:{truncate:{lines:2}}}];return e.jsx("div",{className:"flex flex-wrap gap-8",children:n.map(({key:f,label:s,props:y})=>e.jsxs("div",{className:"max-w-[180px] overflow-hidden",children:[e.jsx(o,{as:"span",size:"caption",tone:"muted",className:"mb-1 block",children:s}),e.jsx(o,{...y,children:r.wrapSample})]},f))})}};var h,b,w;p.parameters={...p.parameters,docs:{...(h=p.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(w=(b=p.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var v,N,S;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: 'Tailles',
