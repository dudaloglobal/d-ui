...
occupent tout l'espace restant.`}}};const N={title:"Components/Divider",component:n,argTypes:w},i={name:"Horizontal",parameters:u("import { Divider } from 'd-ui';","<Divider />"),render:(s,{globals:a})=>{const r=m(x(a.locale));return e.jsxs("div",{className:"flex w-full flex-col gap-4",children:[e.jsx(t,{children:r.previous}),e.jsx(n,{...s}),e.jsx(t,{children:r.next})]})}},o={name:"Vertical",args:{orientation:"vertical"},parameters:u("import { Divider } from 'd-ui';",'<Divider orientation="vertical" />'),render:(s,{globals:a})=>{const r=m(x(a.locale));return e.jsxs("div",{className:"flex h-8 items-center gap-4",children:[e.jsx(t,{as:"span",children:r.drafts}),e.jsx(n,{...s}),e.jsx(t,{as:"span",children:r.published})]})}},l={name:"Labellisé",args:{label:"Fin des résultats pertinents"},parameters:u("import { Divider } from 'd-ui';",'<Divider label="Fin des résultats pertinents" />'),render:(s,{globals:a})=>{const r=m(x(a.locale));return e.jsxs("div",{className:"flex w-full flex-col gap-4",children:[e.jsx(t,{children:r.relevant}),e.jsx(n,{...s,label:r.labelled}),e.jsx(t,{tone:"muted",children:r.other})]})}};var f,v,g;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: 'Horizontal',
