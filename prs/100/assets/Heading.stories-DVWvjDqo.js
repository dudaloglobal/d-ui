import{j as a,f as S,t,d}from"./iframe-DwQTNPAe.js";import{i as N,c}from"./docs-source-Dhouib-y.js";const j={display:"text-4xl font-bold tracking-tight",title:"text-2xl font-semibold",subtitle:"text-xl font-semibold",body:"text-base font-semibold"},_={1:"display",2:"title",3:"subtitle",4:"body",5:"body",6:"body"};function l({level:s,size:i,className:e,...b}){const h=`h${s}`,z=i??_[s];return a.jsx(h,{className:S("text-fg text-balance",j[z],e),...b})}l.__docgenInfo={description:`Titre du design system.
...
}`,...(f=(x=o.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};const L=["Default","Levels","SizeDecoupledFromLevel"],P=Object.freeze(Object.defineProperty({__proto__:null,Default:r,Levels:n,SizeDecoupledFromLevel:o,__namedExportsOrder:L,default:D},Symbol.toStringTag,{value:"Module"}));export{r as D,P as H,n as L,o as S};
