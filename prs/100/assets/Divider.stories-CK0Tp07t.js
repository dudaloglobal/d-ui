...
occupent tout l'espace restant.`}}};const N={title:"Components/Divider",component:n,argTypes:w},i={name:"Horizontal",parameters:x("import { Divider } from 'd-ui';","<Divider />"),render:(s,{globals:a})=>{const r=u(m(a.locale));return e.jsxs("div",{className:"flex w-full flex-col gap-4",children:[e.jsx(t,{children:r.previous}),e.jsx(n,{...s}),e.jsx(t,{children:r.next})]})}},l={name:"Vertical",args:{orientation:"vertical"},parameters:x("import { Divider } from 'd-ui';",'<Divider orientation="vertical" />'),render:(s,{globals:a})=>{const r=u(m(a.locale));return e.jsxs("div",{className:"flex h-8 items-center gap-4",children:[e.jsx(t,{as:"span",children:r.drafts}),e.jsx(n,{...s}),e.jsx(t,{as:"span",children:r.published})]})}},o={name:"Labellisé",args:{label:"Fin des résultats pertinents"},parameters:x("import { Divider } from 'd-ui';",'<Divider label="Fin des résultats pertinents" />'),render:(s,{globals:a})=>{const r=u(m(a.locale));return e.jsxs("div",{className:"flex w-full flex-col gap-4",children:[e.jsx(t,{children:r.relevant}),e.jsx(n,{...s,label:r.labelled}),e.jsx(t,{tone:"muted",children:r.other})]})}};var f,v,g;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: 'Horizontal',
...
}`,...(g=(v=i.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var h,b,y;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: 'Vertical',
  args: {
...
}`,...(y=(b=l.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var j,D,T;o.parameters={...o.parameters,docs:{...(j=o.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: 'Labellisé',
  args: {
...
}`,...(T=(D=o.parameters)==null?void 0:D.docs)==null?void 0:T.source}}};const S=["Default","Vertical","Labelled"],_=Object.freeze(Object.defineProperty({__proto__:null,Default:i,Labelled:o,Vertical:l,__namedExportsOrder:S,default:N},Symbol.toStringTag,{value:"Module"}));export{_ as D,o as L,l as V,i as a};
