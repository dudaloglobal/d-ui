import{G as s,I as l,d as p,j as e}from"./iframe-BKBj04mU.js";import{y as v}from"./arg-types-C5N8fnnN.js";import{c as f}from"./docs-source-C_O40UCi.js";import{B as h}from"./Button-PAQzA8aq.js";const B={title:"Foundations/ThemeProvider",component:s,args:{children:null},argTypes:v,parameters:{controls:{include:["mode","className"]}}},r={name:"Surcharge de marque",parameters:f("import { Button, ThemeProvider } from 'd-ui';",`<ThemeProvider
  tokens={{
    brand: '#7c3aed',
    brandHover: '#6d28d9',
    onBrand: '#ffffff',
...
</ThemeProvider>`),render:(y,{globals:t})=>{const n=l(p(t.locale));return e.jsx(s,{tokens:{brand:"#7c3aed",brandHover:"#6d28d9",onBrand:"#ffffff",focus:"#7c3aed"},children:e.jsx(h,{children:n.brand})})}},o={name:"Système",parameters:f("import { Button, ThemeProvider } from 'd-ui';",`<ThemeProvider mode="system">
  <Button>Continuer</Button>
</ThemeProvider>`),render:(y,{globals:t})=>{const n=l(p(t.locale));return e.jsx(s,{mode:"system",children:e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("p",{className:"m-0 text-sm opacity-80",children:n.systemHint}),e.jsx(h,{children:n.system})]})})}};var a,d,m;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
