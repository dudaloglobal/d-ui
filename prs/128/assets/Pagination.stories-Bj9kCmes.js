import{x as i,d as t,j as e,y as v,r as Q}from"./iframe-BKBj04mU.js";import{p as W}from"./arg-types-C5N8fnnN.js";import{c as U,b as X}from"./docs-source-C_O40UCi.js";import{C as Y,d as Z,e as ee}from"./Card-BUjhw1n3.js";import{T as ae}from"./Text-BbERpV5A.js";import{P as y,a as w,b as V,c as L,d as ne}from"./Pagination-Bvu1NiRS.js";const oe=`import { useState } from 'react';
...
}`,...(_=(S=p.parameters)==null?void 0:S.docs)==null?void 0:_.source}}};var F,z,D;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(D=(z=u.parameters)==null?void 0:z.docs)==null?void 0:D.source}}};var B,T,M;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Désactivé',
...
/>\`),
  ...
  render: (_, {
    ...
    const copy = paginationCopy(docsLocale(globals.locale));
    return <FooterShell copy={copy} table={tableDataCopy(docsLocale(globals.locale))}>
        {() => <div className="flex w-full items-center justify-between gap-4">
            <PaginationPrevious showLabel />
            <PaginationPages />
            <PaginationNext showLabel />
