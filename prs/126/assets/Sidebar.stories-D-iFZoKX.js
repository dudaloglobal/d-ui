...
</Sidebar>`),render:(r,{globals:n})=>{const a=C(k(n.locale));return e.jsx("div",{className:"h-72",children:e.jsxs(h,{...r,label:a.label,children:[e.jsx(i,{href:"#accueil",current:!0,children:a.home}),e.jsxs(le,{label:a.courses,icon:e.jsx(f,{as:Pe}),defaultOpen:!0,children:[e.jsx(i,{href:"#maths",children:a.maths}),e.jsx(i,{href:"#histoire",children:a.history})]})]})})}},j={name:"Superposition",parameters:we($e,`const [open, setOpen] = useState(false);
return (
    <>
...
}`,...(G=(P=I.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var E,z,Z;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Avec icônes',
  parameters: componentSource(importSidebar, \`<Sidebar label="Navigation principale">
    <SidebarItem href="/accueil" icon={<Icon as={HomeIcon} />} current>
        Accueil
...
}`,...(U=(W=x.parameters)==null?void 0:W.docs)==null?void 0:U.source}}};var Q,J,K;y.parameters={...y.parameters,docs:{...(Q=y.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: 'Imbriqués',
  parameters: componentSource(importSidebar, \`<Sidebar label="Navigation principale">
    <SidebarItem href="/accueil" current>
        Accueil
