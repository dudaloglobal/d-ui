...
/>`),render:(r,{globals:l})=>{const e=d(u(l.locale)),[s,n]=c.useState(null),[p,N]=c.useState(void 0);return c.useEffect(()=>{if(!s){N(void 0);return}const v=URL.createObjectURL(s);return N(v),()=>URL.revokeObjectURL(v)},[s]),o.jsxs("div",{className:"flex items-center gap-4",children:[o.jsx(cr,{src:p,name:e.photoLabel,size:"xxl"}),o.jsx(i,{...r,label:e.photoLabel,accept:"image/*",dropzone:!1,preview:"none",browseLabel:e.photoBrowse,files:s?[s]:[],onFilesChange:v=>n(v[0]??null)}),s?o.jsx(W,{variant:"ghost",onClick:()=>n(null),children:e.deletePhoto}):o.jsx(Z,{as:"span",size:"body-sm",tone:"muted",children:e.noFile})]})}};var de,ue,me;S.parameters={...S.parameters,docs:{...(de=S.parameters)==null?void 0:de.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(ge=(be=z.parameters)==null?void 0:be.docs)==null?void 0:ge.source}}};var ye,ve,he;j.parameters={...j.parameters,docs:{...(ye=j.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  name: 'Clic seul',
...
}`,...(he=(ve=j.parameters)==null?void 0:ve.docs)==null?void 0:he.source}}};var xe,we,Fe;q.parameters={...q.parameters,docs:{...(xe=q.parameters)==null?void 0:xe.docs,source:{originalSource:`{
