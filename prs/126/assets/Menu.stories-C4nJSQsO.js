...
import { Button, Icon, Menu, MenuItem, MenuSeparator } from 'd-ui';`,Un="import { Button, ContextMenu, Menu, MenuItem, MenuSeparator } from 'd-ui';",Yn={title:"Components/Menu",component:l,argTypes:cn,args:{trigger:e.jsx("span",{}),children:e.jsx("span",{})}},L={name:"Par défaut",parameters:h(C,`<Menu label="Actions du devoir" trigger={<Button variant="secondary">Actions</Button>}>
...
</>`),render:(t,{globals:r})=>{const n=b(y(r.locale)),u=e.jsxs(e.Fragment,{children:[e.jsx(o,{children:n.rename}),e.jsx(o,{children:n.duplicate})]});return e.jsxs("div",{className:"flex flex-wrap items-center gap-4",children:[e.jsx(l,{...t,label:n.label,trigger:e.jsx(M,{variant:"secondary",icon:e.jsx(q,{as:Pn}),iconPosition:"end",children:n.actions}),children:u}),e.jsxs(l,{label:n.label,trigger:e.jsx(mn,{icon:e.jsx(q,{as:_n}),"aria-label":n.moreActions}),children:[e.jsx(o,{children:n.rename}),e.jsx(o,{children:n.duplicate})]}),e.jsxs(l,{label:n.label,trigger:e.jsx(dn,{href:"#actions",children:n.actions}),children:[e.jsx(o,{children:n.rename}),e.jsx(o,{children:n.duplicate})]}),e.jsxs(l,{label:n.label,trigger:e.jsx(M,{variant:"secondary",size:"sm",className:"rounded-full",children:n.actions}),children:[e.jsx(o,{children:n.rename}),e.jsx(o,{children:n.duplicate})]})]})}},P={name:"Éléments du menu",parameters:h(Zn,`<Menu label="Actions du devoir" trigger={<Button variant="secondary">Actions</Button>}>
...
</>`),render:(t,{globals:r})=>{const n=b(y(r.locale));return e.jsxs("div",{className:"flex flex-col items-start gap-4",children:[e.jsxs(l,{...t,label:n.fileLabel,trigger:e.jsx(M,{variant:"secondary",children:n.actions}),children:[e.jsx(o,{children:n.open}),e.jsx(o,{children:n.download}),e.jsx(A,{}),e.jsx(o,{children:n.delete})]}),e.jsxs(He,{label:n.fileLabel,trigger:e.jsx("button",{type:"button",className:"rounded-md border border-border bg-bg px-4 py-8 text-start text-fg",children:n.card}),children:[e.jsx(o,{children:n.open}),e.jsx(o,{children:n.download}),e.jsx(A,{}),e.jsx(o,{children:n.delete})]})]})}},$={name:"Tailles",parameters:h(C,`<>
...
}`,...(De=(Re=O.parameters)==null?void 0:Re.docs)==null?void 0:De.source}}};var Te,qe,Ce;_.parameters={..._.parameters,docs:{...(Te=_.parameters)==null?void 0:Te.docs,source:{originalSource:`{
...
}`,...(Ce=(qe=_.parameters)==null?void 0:qe.docs)==null?void 0:Ce.source}}};var Ne,ke,Le;$.parameters={...$.parameters,docs:{...(Ne=$.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  name: 'Tailles',
