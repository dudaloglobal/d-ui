import{j as r,a0 as m,d as y}from"./iframe-DRIDI3J7.js";import{x as E}from"./arg-types-Di6f0Zb7.js";import{c as v}from"./docs-source-C_O40UCi.js";import{B as f}from"./Button-lDgXfmFs.js";import{F as B}from"./FeedbackPlaceholder-VyEKIvx5.js";function j(){return r.jsxs("svg",{width:"2.5rem",height:"2.5rem",viewBox:"0 0 24 24",fill:"none",className:"text-danger","aria-hidden":"true",children:[r.jsx("path",{d:"M12 3.5 20.5 19.5H3.5L12 3.5z",stroke:"currentColor",strokeWidth:"1.75",strokeLinejoin:"round"}),r.jsx("path",{d:"M12 9.5v4.5M12 16.75v.01",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round"})]})}function s({title:t,description:o,icon:e,actions:S,live:h=!1,...x}){return r.jsx(B,{...x,role:h?"alert":void 0,title:t,description:o,icon:e??r.jsx(j,{}),actions:S})}s.__docgenInfo={description:"Placeholder pour un échec de chargement ou une action impossible.",methods:[],displayName:"ErrorState",props:{title:{required:!0,tsType:{name:"ReactNode"},description:""},description:{required:!1,tsType:{name:"ReactNode"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},actions:{required:!1,tsType:{name:"ReactNode"},description:""},live:{required:!1,tsType:{name:"boolean"},description:'Pose `role="alert"` quand l’échec apparaît après le chargement.\nLaissez `false` pour un écran d’erreur statique.',defaultValue:{value:"false",computed:!1}}}};const g="import { Button, ErrorState } from 'd-ui';",b={title:"Components/ErrorState",component:s,argTypes:E,args:{title:"Placeholder"}},a={name:"Par défaut",parameters:v(g,`<ErrorState
