...
</AlertDialog>`),render:(t,{globals:i})=>e.jsx(Ba,{copy:f(D(i.locale))})},X={name:"Pied de page fixe",args:y,parameters:h(T,`<Dialog open={open} onOpenChange={setOpen}>
...
</Dialog>`),render:(t,{globals:i})=>{const n=f(D(i.locale));return e.jsx(B,{copy:n,variant:"primary",label:n.deactivate,children:(o,a)=>e.jsxs(g,{open:o,onOpenChange:a,alert:!0,children:[e.jsxs("div",{className:"flex gap-4",children:[e.jsx("span",{className:"bg-danger/15 text-danger flex size-10 shrink-0 items-center justify-center rounded-full",children:e.jsx(Bn,{as:ma,size:"md"})}),e.jsxs("div",{children:[e.jsx(d,{className:"pe-0",children:n.deactivateTitle}),e.jsx(v,{children:n.deactivateBody})]})]}),e.jsxs(u,{children:[e.jsx(l,{variant:"secondary",onClick:()=>a(!1),children:n.cancel}),e.jsx(l,{variant:"primary",onClick:()=>a(!1),children:n.deactivate})]})]})})}},ae={name:"Avec croix de fermeture",args:y,parameters:h(T,`<Dialog open={open} onOpenChange={setOpen} dismissible dismissLabel="Fermer">
...
</Dialog>`),render:(t,{globals:i})=>e.jsx(Aa,{copy:f(D(i.locale))})},re={name:"Bordure et coins",args:y,parameters:h(T,`<Dialog open={open} onOpenChange={setOpen} bordered radius="xl">
...
}`,...(qe=(we=G.parameters)==null?void 0:we.docs)==null?void 0:qe.source}}};var Ie,_e,ze;J.parameters={...J.parameters,docs:{...(Ie=J.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  name: 'Confirmation',
  args: closed,
...
}`,...(ze=(_e=J.parameters)==null?void 0:_e.docs)==null?void 0:ze.source}}};var Re,Pe,Ee;Z.parameters={...Z.parameters,docs:{...(Re=Z.parameters)==null?void 0:Re.docs,source:{originalSource:`{
...
}`,...(Ee=(Pe=Z.parameters)==null?void 0:Pe.docs)==null?void 0:Ee.source}}};var Fe,Ve,He;X.parameters={...X.parameters,docs:{...(Fe=X.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
...
}`,...(He=(Ve=X.parameters)==null?void 0:Ve.docs)==null?void 0:He.source}}};var Ke,Me,$e;Y.parameters={...Y.parameters,docs:{...(Ke=Y.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
...
}`,...(Tn=(bn=ce.parameters)==null?void 0:bn.docs)==null?void 0:Tn.source}}};const ka=["Default","ConfirmDialog","AlertKinds","TintedFooter","CenteredSingleAction","CenteredWideButtons","Alert","WithDismissButton","AlertLeftAligned","Sizes","Processing","PanelChrome","Scrollable","Animation","WithForm"],Ma=Object.freeze(Object.defineProperty({__proto__:null,Alert:ne,AlertKinds:Z,AlertLeftAligned:ie,Animation:le,CenteredSingleAction:Y,CenteredWideButtons:ee,ConfirmDialog:J,Default:G,PanelChrome:re,Processing:te,Scrollable:se,Sizes:oe,TintedFooter:X,WithDismissButton:ae,WithForm:ce,__namedExportsOrder:ka,default:Ca},Symbol.toStringTag,{value:"Module"}));export{Z as A,J as C,Ma as D,te as P,se as S,X as T,ae as W,G as a,Y as b,ee as c,ne as d,ie as e,ce as f,oe as g,re as h,le as i};
