import{r as s,j as e,i as ve,q as l,d as i}from"./iframe-Cwdk0Wk1.js";import{J as he}from"./arg-types-DPco8aiO.js";import{c as d,b as Te}from"./docs-source-C_O40UCi.js";import{B as c}from"./Button-D_satCit.js";import{n as Se,u as Be,a as be,p as xe,q as Ee,c as je,d as Ce,e as Ae,g as Oe,F as _e,O,f as we,i as De,o as Re,j as Me,s as Pe,k as Ne,l as qe,m as _}from"./floating-C3MKyGzx.js";import{c as Le}from"./cornerRadius-B4XFh-_5.js";const Fe=200;function n({content:r,children:o,placement:t="top",open:a,defaultOpen:X=!1,onOpenChange:b,delayMs:Z=Fe,disabled:B=!1,radius:$="md",className:ee}){const E=s.useId(),j=s.useRef(null),te=Se(),[oe,re]=s.useState(X),[ne,ae]=s.useState(null),se=a!==void 0,x=B?!1:a??oe,le=p=>{B&&p||(se||re(p),b==null||b(p))},{refs:C,floatingStyles:ie,context:m}=Be({open:x,onOpenChange:le,placement:t,middleware:[Re(O+4),Me({padding:_,fallbackAxisSideDirection:"start"}),Pe({padding:_}),Ne({element:j,padding:6})],whileElementsMounted:De}),ce=be(ne),A=qe(ce),pe=xe(m,{enabled:!B,move:!1,delay:{open:te?0:Z,close:0}}),de=Ee(m,{enabled:!B}),ue=je(m,{ancestorScroll:!0}),me=Ce(m,{role:"tooltip"}),{getReferenceProps:ye,getFloatingProps:ge}=Ae([pe,de,ue,me]),fe=s.isValidElement(o)?s.cloneElement(o,ye({"aria-describedby":x?E:void 0})):o;return e.jsxs(e.Fragment,{children:[e.jsx("span",{ref:p=>{C.setReference(p),ae(p)},className:"inline-flex max-w-full",children:fe}),x?e.jsx(Oe,{children:e.jsxs("div",{ref:C.setFloating,style:ie,...ge(),...A,id:E,className:ve(A.className,"pointer-events-none max-w-xs bg-fg px-2 py-1 text-sm text-bg shadow-md",Le[$],ee),children:[r,e.jsx(_e,{ref:j,context:m,width:we,height:O,className:"d-ui-tooltip-arrow","data-d-ui-tooltip-arrow":"","aria-hidden":!0})]})}):null]})}n.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"ReactNode"},description:"Contenu non interactif. Ne pas y placer de bouton, lien ou champ."},children:{required:!0,tsType:{name:"ReactElement"},description:"Déclencheur unique (focusable). `Button` n’expose pas de ref : un wrapper sert de référence."},placement:{required:!1,tsType:{name:"union",raw:`| 'top'
| 'top-start'
| 'top-end'
| 'bottom'
| 'bottom-start'
...
}`,...(N=(P=g.parameters)==null?void 0:P.docs)==null?void 0:N.source}}};var q,L,F;f.parameters={...f.parameters,docs:{...(q=f.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'Contrôlé',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(F=(L=f.parameters)==null?void 0:L.docs)==null?void 0:F.source}}};var V,I,H;v.parameters={...v.parameters,docs:{...(V=v.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Désactivé',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
