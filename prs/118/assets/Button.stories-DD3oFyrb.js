...
<Button variant="secondary" isSelected>
  Abonné
</Button>`),render:(e,{globals:n})=>{const t=s(i(n.locale));return o.jsxs(y,{children:[o.jsx(a,{variant:"secondary",children:t.subscribe}),o.jsx(a,{variant:"secondary",isSelected:!0,children:t.subscribed})]})}},B={name:"Faible emphase",parameters:u("import { Button } from 'd-ui';",`<Button variant="ghost">Par défaut</Button>
...
<IconButton loading loadingIndicator="bounce" icon={plus} aria-label="Ajouter" />`,x),render:(e,{globals:n})=>{const t=s(i(n.locale));return o.jsxs("div",{className:"flex flex-col gap-4",children:[o.jsxs(y,{children:[o.jsx(a,{loading:!0,children:t.saving}),o.jsx(a,{loading:!0,variant:"secondary",children:t.saving}),o.jsx(a,{loading:!0,variant:"ghost",children:t.saving}),o.jsx(I,{loading:!0,icon:o.jsx(S,{}),"aria-label":t.add})]}),o.jsxs(y,{children:[o.jsx(a,{loading:!0,loadingIndicator:"bounce",children:t.saving}),o.jsx(a,{loading:!0,loadingIndicator:"bounce",variant:"secondary",children:t.saving}),o.jsx(a,{loading:!0,loadingIndicator:"bounce",variant:"ghost",children:t.saving}),o.jsx(I,{loading:!0,loadingIndicator:"bounce",icon:o.jsx(S,{}),"aria-label":t.add})]})]})}},b={name:"Icône seule",parameters:u("import { IconButton } from 'd-ui';",'<IconButton icon={plus} aria-label="Ajouter" />',x),render:(e,{globals:n})=>{const t=s(i(n.locale));return o.jsx(I,{icon:o.jsx(S,{}),"aria-label":t.add})}},uo=["none","sm","md","lg","xl"],f={name:"Arrondi",parameters:u("import { Button } from 'd-ui';",'<Button radius="lg">Continuer</Button>'),render:(e,{globals:n})=>{const t=s(i(n.locale));return o.jsxs(y,{children:[uo.map(r=>o.jsx(a,{radius:r,variant:"secondary",children:r},r)),o.jsx(a,{radius:"lg",children:t.continue})]})}};var C,E,P;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Par défaut',
  render: (args, {
    globals
  }) => {
...
}`,...(Y=(X=b.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,oo,to;f.parameters={...f.parameters,docs:{...(Z=f.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  name: 'Arrondi',
...
}`,...(to=(oo=f.parameters)==null?void 0:oo.docs)==null?void 0:to.source}}};const co=["Primary","HighEmphasis","MediumEmphasis","Toggled","LowEmphasis","SmallSize","FullWidth","Loading","IconOnly","Radius"],ho=Object.freeze(Object.defineProperty({__proto__:null,FullWidth:h,HighEmphasis:d,IconOnly:b,Loading:v,LowEmphasis:B,MediumEmphasis:p,Primary:l,Radius:f,SmallSize:g,Toggled:m,__namedExportsOrder:co,default:io},Symbol.toStringTag,{value:"Module"}));export{ho as B,h as F,d as H,b as I,B as L,p as M,f as R,g as S,m as T,v as a};
