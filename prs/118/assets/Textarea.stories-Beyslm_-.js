...
/>`),render:(l,{globals:a})=>{const e=n(s(a.locale));return t.jsx(u,{label:e.textareaLabel,maxLength:200,countMessage:De(e)})}},f={name:"Halo de focus",parameters:o(`<Textarea
    ...
    focusShadow
    onChange={(event) => setValue(event.target.value)}
/>`),render:(l,{globals:a})=>{const e=n(s(a.locale));return t.jsx(u,{label:e.textareaLabel,focusShadow:!0})}};var A,W,G;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(G=(W=c.parameters)==null?void 0:W.docs)==null?void 0:G.source}}};var J,U,K;d.parameters={...d.parameters,docs:{...(J=d.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: 'Désactivé',
  parameters: textareaSource(\`<Textarea
    label="Libellé de la zone de texte"
    value={value}
...
}`,...(K=(U=d.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var Q,X,Y;m.parameters={...m.parameters,docs:{...(Q=m.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: 'Valide',
  parameters: textareaSource(\`<Textarea
    label="Libellé de la zone de texte"
    value={value}
