...
>
    Nouvelle fonctionnalité disponible.
</Alert>`),render:(e,{globals:n})=>{const a=l(c(n.locale));return r.jsx(o,{...e,icon:r.jsx(i,{as:y,size:"md"}),actions:r.jsx(ie,{size:"sm",variant:"ghost",children:a.learnMore}),children:a.featureBody})}};var I,k,L;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'Par défaut',
  args: {
    variant: 'info'
  },
...
}`,...(L=(k=u.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};var C,z,T;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Variantes',
...
}`,...(T=(z=p.parameters)==null?void 0:z.docs)==null?void 0:T.source}}};var S,N,E;f.parameters={...f.parameters,docs:{...(S=f.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: 'Avec titre',
  args: {
    variant: 'warning'
  },
...
}`,...(_=(W=A.parameters)==null?void 0:W.docs)==null?void 0:_.source}}};const je=["Default","Variants","WithTitle","Dismissible","Trimmed","WithAction"],Re=Object.freeze(Object.defineProperty({__proto__:null,Default:u,Dismissible:g,Trimmed:v,Variants:p,WithAction:A,WithTitle:f,__namedExportsOrder:je,default:we},Symbol.toStringTag,{value:"Module"}));export{Re as A,u as D,v as T,p as V,f as W,g as a,A as b};
