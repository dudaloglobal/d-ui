...
/>`),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(Ea,{copy:e})}},Y={name:"Chargement",args:{options:[]},parameters:ne('<Combobox label="Ville" options={[]} listStatus="loading" defaultOpen />'),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:[],listStatus:"loading",loadingMessage:e.loading,defaultOpen:!0,...t(e)})}},J={name:"Chargement de la suite",args:{options:[]},parameters:ne('<Combobox label="Ville" options={options} listStatus="loadingMore" defaultOpen />'),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:y(e),listStatus:"loadingMore",loadingMessage:e.loadingMore,defaultOpen:!0,...t(e)})}},X={name:"État vide",args:{options:[]},parameters:ne("<Combobox label=\"Ville\" options={[]} emptyMessage={(query) => query ? `Aucun résultat pour « ${query} »` : 'Aucune option'} defaultOpen />"),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:[],emptyMessage:i=>i?`${e.emptyQuery} « ${i} »`:e.empty,defaultOpen:!0,...t(e)})}},Z={name:"Erreur de liste",args:{options:[]},parameters:ne(`<Combobox
    label="Ville"
    options={[]}
    listStatus="error"
...
}`,...(Ue=(Ke=$.parameters)==null?void 0:Ke.docs)==null?void 0:Ue.source}}};var Ye,Je,Xe;B.parameters={...B.parameters,docs:{...(Ye=B.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  name: 'Invalide',
  args: {
    options: []
  },
...
}`,...(Xe=(Je=B.parameters)==null?void 0:Je.docs)==null?void 0:Xe.source}}};var Ze,eo,oo;P.parameters={...P.parameters,docs:{...(Ze=P.parameters)==null?void 0:Ze.docs,source:{originalSource:`{
  name: 'Requis',
  args: {
    options: []
  },
...
}`,...(ho=(vo=U.parameters)==null?void 0:vo.docs)==null?void 0:ho.source}}};var Co,So,qo;Y.parameters={...Y.parameters,docs:{...(Co=Y.parameters)==null?void 0:Co.docs,source:{originalSource:`{
  name: 'Chargement',
  args: {
    options: []
  },
...
}`,...(qo=(So=Y.parameters)==null?void 0:So.docs)==null?void 0:qo.source}}};var Vo,jo,Ro;J.parameters={...J.parameters,docs:{...(Vo=J.parameters)==null?void 0:Vo.docs,source:{originalSource:`{
...
}`,...(Ro=(jo=J.parameters)==null?void 0:jo.docs)==null?void 0:Ro.source}}};var No,wo,Mo;X.parameters={...X.parameters,docs:{...(No=X.parameters)==null?void 0:No.docs,source:{originalSource:`{
  name: 'État vide',
  args: {
    options: []
  },
...
}`,...(Mo=(wo=X.parameters)==null?void 0:wo.docs)==null?void 0:Mo.source}}};var To,Lo,ko;Z.parameters={...Z.parameters,docs:{...(To=Z.parameters)==null?void 0:To.docs,source:{originalSource:`{
...
}`,...(Io=(_o=ee.parameters)==null?void 0:_o.docs)==null?void 0:Io.source}}};const za=["Default","Multiple","Disabled","Invalid","Required","Helper","Valid","Sizes","Group","Descriptions","Custom","Loading","LoadingMore","Empty","ListError","FilterTypes"],Wa=Object.freeze(Object.defineProperty({__proto__:null,Custom:U,Default:A,Descriptions:K,Disabled:$,Empty:X,FilterTypes:ee,Group:Q,Helper:G,Invalid:B,ListError:Z,Loading:Y,LoadingMore:J,Multiple:F,Required:P,Sizes:W,Valid:H,__namedExportsOrder:za,default:Da},Symbol.toStringTag,{value:"Module"}));export{Wa as C,A as D,X as E,ee as F,Q as G,G as H,B as I,Y as L,F as M,P as R,W as S,H as V,K as a,U as b,$ as c,J as d,Z as e};
