import{k as n,d as o,j as r}from"./iframe-CSDJ8R1k.js";import{f as cr}from"./arg-types-B_nef0fB.js";import{c as t}from"./docs-source-C_O40UCi.js";import{U as lr,a as Cr}from"./uiScale-DBauGOvS.js";import{A as pr}from"./Avatar-kEUmyX2p.js";import{T as mr}from"./Tag-DAanEdjS.js";import{B as D}from"./Button-DCvfpArC.js";import{C as s,a as i,b as c,c as C,d as m,e as or,f as tr}from"./Card-BPf7tI8A.js";const l=`import {
    Avatar,
    Tag,
    Button,
    Card,
...
<Card radius="lg">…</Card>
<Card radius="xl">…</Card>`),render:(e,{globals:d})=>{const a=n(o(d.locale)),p=["sm","lg","xl"];return r.jsx("div",{className:"flex flex-col gap-4",children:p.map(B=>r.jsx(s,{...e,radius:B,className:"max-w-sm",children:r.jsx(i,{children:r.jsxs(c,{children:[a.title," (",B,")"]})})},B))})}},T={name:"Tailles",parameters:t(l,`<Card size="s">…</Card>
<Card size="m">…</Card>
...
}`,...(Q=(K=j.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};var V,X,Y;T.parameters={...T.parameters,docs:{...(V=T.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Tailles',
...
}`,...(Y=(X=T.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var rr,ar,er;f.parameters={...f.parameters,docs:{...(rr=f.parameters)==null?void 0:rr.docs,source:{originalSource:`{
  name: 'Couleurs',
...
}`,...(nr=(sr=H.parameters)==null?void 0:sr.docs)==null?void 0:nr.source}}};const xr=["Default","WithMedia","HeaderAndFooter","Horizontal","AsLink","AsButton","AsButtonDisabled","Radius","Sizes","Colors","Composition"],Br=Object.freeze(Object.defineProperty({__proto__:null,AsButton:b,AsButtonDisabled:v,AsLink:h,Colors:f,Composition:H,Default:u,HeaderAndFooter:x,Horizontal:y,Radius:j,Sizes:T,WithMedia:g,__namedExportsOrder:xr,default:gr},Symbol.toStringTag,{value:"Module"}));export{h as A,Br as C,u as D,x as H,j as R,T as S,g as W,y as a,b,v as c,f as d,H as e};
