import{j as c,h as u}from"./iframe-CfESPI1b.js";const d="Skip to main content";function f({href:e="#main",className:s,children:l=d,onClick:t,...o}){function r(a){if(t==null||t(a),a.defaultPrevented)return;const i=e.startsWith("#")?e.slice(1):"";if(!i)return;const n=document.getElementById(i);n&&(n.focus(),document.activeElement===n&&a.preventDefault())}return c.jsx("a",{...o,href:e,className:u("d-ui-skip-link",s),onClick:r,children:l})}f.__docgenInfo={description:`First focusable control in an app shell. Visible on keyboard focus only.
