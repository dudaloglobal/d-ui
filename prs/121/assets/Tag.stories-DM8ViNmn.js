import{D as t,d as l,j as r,r as x}from"./iframe-CSDJ8R1k.js";import{r as X}from"./arg-types-B_nef0fB.js";import{c as i}from"./docs-source-C_O40UCi.js";import{U as Y,a as $}from"./uiScale-DBauGOvS.js";import{I as aa}from"./Icon-CtovchWW.js";import{T as n,a as ea}from"./Tag-DAanEdjS.js";import{F as ra}from"./CheckIcon-BbdaaizS.js";const g="import { Icon, Tag, TagGroup } from 'd-ui';",Q=["default","success","warning","danger","info","neutral"],sa={title:"Components/Tag",component:n,argTypes:X},p={name:"Par défaut",args:{variant:"default"},parameters:i(g,"<Tag>Nouveau</Tag>"),render:(e,{globals:s})=>{const a=t(l(s.locale));return r.jsx(n,{...e,children:a.defaultLabel})}},u={name:"Variantes",parameters:i(g,`<Tag variant="default">Nouveau</Tag>
...
}`,...(k=(z=m.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};var G,D,_;d.parameters={...d.parameters,docs:{...(G=d.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: 'Tailles',
...
}`,...(_=(D=d.parameters)==null?void 0:D.docs)==null?void 0:_.source}}};var P,R,O;T.parameters={...T.parameters,docs:{...(P=T.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'Couleurs',
