import{q as i,d as t,j as e,w as v,r as Q}from"./iframe-CfESPI1b.js";import{p as W}from"./arg-types-B3Y5nyvA.js";import{c as U,b as X}from"./docs-source-C_O40UCi.js";import{C as Y,d as Z,e as ee}from"./Card-Dk-KSvvd.js";import{T as ae}from"./Text-BtWIrh7s.js";import{P as y,a as w,b as V,c as L,d as ne}from"./Pagination-BvgZu0ab.js";const oe=`import { useState } from 'react';
...
/>`),render:(o,{globals:a})=>{const n=i(t(a.locale));return e.jsx(g,{copy:n,pageCount:8})}},u={name:"Beaucoup de pages",parameters:f(`<Pagination
    page={page}
    pageCount={24}
    onPageChange={setPage}
    label="Pagination des devoirs"
    previousLabel="Page précédente"
    nextLabel="Page suivante"
/>`,"12"),render:(o,{globals:a})=>{const n=i(t(a.locale));return e.jsx(g,{copy:n,pageCount:24,initial:12})}},d={name:"Désactivé",parameters:U("import { Pagination } from 'd-ui';",`<Pagination
    page={3}
    pageCount={8}
    disabled
    onPageChange={() => {}}
...
}`,...(_=(S=p.parameters)==null?void 0:S.docs)==null?void 0:_.source}}};var F,z,B;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(B=(z=u.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var D,T,M;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Désactivé',
...
/>\`),
...
}`,...(M=(T=d.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};var E,O,$;m.parameters={...m.parameters,docs:{...(E=m.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Tailles',
  ...
  render: (_, {
    ...
    const copy = paginationCopy(docsLocale(globals.locale));
    return <FooterShell copy={copy} table={tableCopy(docsLocale(globals.locale))}>
        {() => <div className="flex w-full items-center justify-between gap-4">
            <PaginationPrevious showLabel />
            <PaginationPages />
            <PaginationNext showLabel />
  ...
  render: (_, {
    ...
    const copy = paginationCopy(docsLocale(globals.locale));
    const table = tableCopy(docsLocale(globals.locale));
...
}`,...(K=(J=C.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const se=["Default","ManyPages","Disabled","Sizes","CardFooterPages","CenteredPages","SimpleCardFooter"],ue=Object.freeze(Object.defineProperty({__proto__:null,CardFooterPages:P,CenteredPages:b,Default:p,Disabled:d,ManyPages:u,SimpleCardFooter:C,Sizes:m,__namedExportsOrder:se,default:te},Symbol.toStringTag,{value:"Module"}));export{p as D,u as M,ue as P,m as S,d as a};
