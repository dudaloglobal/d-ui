import{r as H,h as Y,j as o,d as f,a5 as g}from"./iframe-CfESPI1b.js";import{D as Z}from"./arg-types-B3Y5nyvA.js";import{c as x}from"./docs-source-C_O40UCi.js";import{V as ee}from"./VisuallyHidden-BTua8iSE.js";const ae={sm:"text-sm",md:"text-base"},te=[{unit:"year",ms:365.25*24*60*60*1e3},{unit:"month",ms:365.25/12*24*60*60*1e3},{unit:"week",ms:10080*60*1e3},{unit:"day",ms:1440*60*1e3},{unit:"hour",ms:3600*1e3},{unit:"minute",ms:60*1e3},{unit:"second",ms:1e3}];function oe(e){return e instanceof Date?e:new Date(e)}function re(e){for(const{unit:a,ms:t}of te){const r=Math.trunc(e/t);if(Math.abs(r)>=1||a==="second")return{value:r,unit:a}}return{value:0,unit:"second"}}function se(e,a,t){const{value:r,unit:T}=re(e.getTime()-a.getTime());return{iso:e.toISOString(),relative:new Intl.RelativeTimeFormat(t,{numeric:"auto"}).format(r,T),absolute:new Intl.DateTimeFormat(t,{dateStyle:"long",timeStyle:"short"}).format(e)}}function L(e){const a=Math.abs(e);return a<6e4?1e4:a<36e5?3e4:a<864e5?6e4:36e5}function le(e){if(typeof e=="string")return e;if(Array.isArray(e)){const a=e[0];return typeof a=="string"?a:a==null?void 0:a.toString()}if(e instanceof Intl.Locale)return e.toString()}function s({date:e,locale:a,live:t=!1,size:r="md",className:T,title:G,lang:$,...v}){const[J,K]=H.useState(()=>new Date),j=oe(e),A=j.getTime(),h=!Number.isNaN(A),S=le(a)??$,N=Y("font-sans text-fg",ae[r],T);if(H.useEffect(()=>{if(!t||!h)return;let y;const w=()=>{const D=new Date;K(D),y=setTimeout(w,L(A-D.getTime()))};return y=setTimeout(w,L(A-Date.now())),()=>clearTimeout(y)},[t,h,A]),!h)return o.jsx("span",{...v,lang:S,className:N,children:"—"});const{iso:Q,relative:X,absolute:E}=se(j,J,a);return o.jsxs("time",{...v,dateTime:Q,lang:S,title:G??E,suppressHydrationWarning:!0,className:N,children:[X,o.jsx(ee,{children:`, ${E}`})]})}s.__docgenInfo={description:"",methods:[],displayName:"TimeAgo",props:{date:{required:!0,tsType:{name:"union",raw:"Date | string | number",elements:[{name:"Date"},{name:"string"},{name:"number"}]},description:"Instant à afficher. Accepte un `Date`, une chaîne ISO-8601, ou des\nmillisecondes epoch. Une valeur invalide rend un repli sans `<time>`."},locale:{required:!1,tsType:{name:"Intl.LocalesArgument"},description:"Locale BCP 47 pour le texte relatif et absolu (`fr`, `en-US`, …).\nPose aussi `lang` (WCAG 3.1.2). Défaut : locale d’exécution."},live:{required:!1,tsType:{name:"boolean"},description:'Si `true`, rafraîchit le texte relatif sur un intervalle grossier.\nVisuel uniquement — pas d’`aria-live`. Passez `aria-live="polite"` pour opt-in.',defaultValue:{value:"false",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"}]},description:"Taille du texte. `'md'` par défaut.",defaultValue:{value:"'md'",computed:!1}},title:{required:!1,tsType:{name:"string"},description:"Infobulle native. Défaut : l’heure absolue formatée."}}};const i=60*1e3,b=60*i,ne=24*b;function l(e){return new Date(Date.now()+e)}function n({label:e,hint:a,children:t}){return o.jsxs("div",{className:"font-sans text-fg",children:[o.jsx("p",{className:"m-0 font-medium",children:e}),a?o.jsx("p",{className:"mt-1 mb-2 text-sm opacity-80",children:a}):o.jsx("div",{className:"h-2"}),t]})}const ie={title:"Components/TimeAgo",component:s,args:{date:l(-3*i)},argTypes:Z,parameters:{controls:{include:["date","locale","live","size","title","className"]}}},c={name:"Par défaut",parameters:x("import { TimeAgo } from 'd-ui';",'<TimeAgo date={submission.createdAt} locale="fr" />'),render:(e,{globals:a})=>{const t=f(a.locale),r=g(t);return o.jsx(n,{label:r.submitted,children:o.jsx(s,{...e,locale:t})})}},m={name:"Langue",parameters:x("import { TimeAgo } from 'd-ui';",`<TimeAgo date={createdAt} locale="en" />
<TimeAgo date={createdAt} locale="fr" />`),render:(e,{globals:a})=>{const t=g(f(a.locale));return o.jsxs("div",{className:"flex flex-col gap-6",children:[o.jsx(n,{label:t.english,hint:t.englishHint,children:o.jsx(s,{date:l(-3*i),locale:"en"})}),o.jsx(n,{label:t.french,hint:t.frenchHint,children:o.jsx(s,{date:l(-3*i),locale:"fr"})})]})}},u={name:"Mises à jour en direct",parameters:x("import { TimeAgo } from 'd-ui';",'<TimeAgo date={lastSeenAt} locale="fr" live />'),render:(e,{globals:a})=>{const t=f(a.locale),r=g(t);return o.jsx(n,{label:r.lastSeen,hint:r.liveHint,children:o.jsx(s,{...e,date:l(-15*1e3),locale:t,live:!0})})}},d={name:"Taille",parameters:x("import { TimeAgo } from 'd-ui';",`<TimeAgo date={createdAt} locale="fr" size="sm" />
<TimeAgo date={createdAt} locale="fr" size="md" />`),render:(e,{globals:a})=>{const t=f(a.locale),r=g(t);return o.jsxs("div",{className:"flex flex-col gap-4",children:[o.jsx(n,{label:r.small,hint:'size="sm"',children:o.jsx(s,{...e,date:l(-3*i),locale:t,size:"sm"})}),o.jsx(n,{label:r.medium,hint:r.mediumHint,children:o.jsx(s,{...e,date:l(-3*i),locale:t,size:"md"})})]})}},p={name:"Passé et futur",parameters:x("import { TimeAgo } from 'd-ui';",`<TimeAgo date={fiveHoursAgo} locale="fr" />
<TimeAgo date={inThreeHours} locale="fr" />`),render:(e,{globals:a})=>{const t=f(a.locale),r=g(t);return o.jsxs("div",{className:"flex flex-col gap-6",children:[o.jsx(n,{label:r.past,hint:r.pastHint,children:o.jsx(s,{date:l(-5*b),locale:t})}),o.jsx(n,{label:r.future,hint:r.futureHint,children:o.jsx(s,{date:l(3*b),locale:t})}),o.jsx(n,{label:r.yesterday,children:o.jsx(s,{date:l(-2*ne),locale:t})})]})}};var z,I,P;c.parameters={...c.parameters,docs:{...(z=c.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: 'Par défaut',
