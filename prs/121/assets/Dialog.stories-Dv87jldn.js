...
</Dialog>`),render:(t,{globals:i})=>{const n=f(D(i.locale));return e.jsx(B,{copy:n,variant:"primary",label:n.deactivate,children:(o,a)=>e.jsxs(g,{open:o,onOpenChange:a,alert:!0,children:[e.jsxs("div",{className:"flex gap-4",children:[e.jsx("span",{className:"bg-danger/15 text-danger flex size-10 shrink-0 items-center justify-center rounded-full",children:e.jsx(On,{as:ga,size:"md"})}),e.jsxs("div",{children:[e.jsx(d,{className:"pe-0",children:n.deactivateTitle}),e.jsx(v,{children:n.deactivateBody})]})]}),e.jsxs(u,{children:[e.jsx(l,{variant:"secondary",onClick:()=>a(!1),children:n.cancel}),e.jsx(l,{variant:"primary",onClick:()=>a(!1),children:n.deactivate})]})]})})}},ae={name:"Avec croix de fermeture",args:y,parameters:h(T,`<Dialog open={open} onOpenChange={setOpen} dismissible dismissLabel="Fermer">
...
}`,...(we=(Le=G.parameters)==null?void 0:Le.docs)==null?void 0:we.source}}};var Ie,_e,ze;J.parameters={...J.parameters,docs:{...(Ie=J.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  name: 'Confirmation',
  args: closed,
...
}`,...(Tn=(bn=ce.parameters)==null?void 0:bn.docs)==null?void 0:Tn.source}}};const ja=["Default","ConfirmDialog","AlertKinds","TintedFooter","CenteredSingleAction","CenteredWideButtons","Alert","WithDismissButton","AlertLeftAligned","Sizes","Processing","PanelChrome","Scrollable","Animation","WithForm"],$a=Object.freeze(Object.defineProperty({__proto__:null,Alert:ne,AlertKinds:Z,AlertLeftAligned:ie,Animation:le,CenteredSingleAction:Y,CenteredWideButtons:ee,ConfirmDialog:J,Default:G,PanelChrome:re,Processing:te,Scrollable:se,Sizes:oe,TintedFooter:X,WithDismissButton:ae,WithForm:ce,__namedExportsOrder:ja,default:ba},Symbol.toStringTag,{value:"Module"}));export{Z as A,J as C,$a as D,te as P,se as S,X as T,ae as W,G as a,Y as b,ee as c,ne as d,ie as e,ce as f,oe as g,re as h,le as i};
