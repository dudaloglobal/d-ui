...
<TimePicker size="lg" label="Heure de début" />`),render:(l,{globals:n})=>{const a=v(k(n.locale));return r.jsxs("div",{className:"flex flex-col gap-4",children:[r.jsx(t,{...l,size:"sm",label:`${a.label} (${a.small})`}),r.jsx(t,{...l,size:"md",label:`${a.label} (${a.medium})`}),r.jsx(t,{...l,size:"lg",label:`${a.label} (${a.large})`})]})}};var N,M,O;o.parameters={...o.parameters,docs:{...(N=o.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'Par défaut',
