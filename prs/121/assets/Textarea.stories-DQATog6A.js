...
}`,computed:!1}},rows:{required:!1,tsType:{name:"number"},description:"Nombre de lignes visibles. Défaut : `2`.",defaultValue:{value:"2",computed:!1}}}};const Ne=`import { useState } from 'react';
import { Textarea } from 'd-ui';`;function De(l){return(a,e)=>l.countRemaining(Math.max(0,(e??0)-a))}function o(l,a=""){return Ce(Ne,`const [value, setValue] = useState(${JSON.stringify(a)});
return (
${l.trim().split(`
`).map(e=>`    ${e}`).join(`
`)}
