import{r as u,j as e,h as x,a0 as g,d as y}from"./iframe-CfESPI1b.js";import{q as z}from"./arg-types-B3Y5nyvA.js";import{c as j}from"./docs-source-C_O40UCi.js";import{L as A}from"./Link-DpjB3Lzo.js";const N={sm:"text-sm",md:"text-base",lg:"text-lg"};function T(){return e.jsx("svg",{width:"1em",height:"1em",viewBox:"0 0 16 16",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M6 4l4 4-4 4",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round"})})}function s({label:a="Breadcrumb",size:c="md",className:r,children:n}){const o=u.Children.toArray(n).filter(u.isValidElement);return e.jsx("nav",{"aria-label":a,className:x("font-sans",N[c],r),children:e.jsx("ol",{className:"m-0 flex list-none flex-wrap items-center gap-1 p-0",children:o.map((i,d)=>{const v=d===o.length-1;return e.jsxs("li",{className:"inline-flex items-center gap-1",children:[d>0?e.jsx("span",{className:"inline-flex text-fg/50","aria-hidden":"true",children:e.jsx(T,{})}):null,u.cloneElement(i,{current:v})]},i.key??d)})})})}function m({href:a,current:c=!1,className:r,children:n}){return c||!a?e.jsx("span",{"aria-current":c?"page":void 0,className:x(c?"font-medium text-fg":"text-fg/70",r),children:n}):e.jsx(A,{href:a,className:r,children:n})}s.__docgenInfo={description:"",methods:[],displayName:"Breadcrumb",props:{label:{required:!1,tsType:{name:"string"},description:"Nom accessible du `nav`. Fallback anglais si omis.",defaultValue:{value:"'Breadcrumb'",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};m.__docgenInfo={description:"",methods:[],displayName:"BreadcrumbItem",props:{href:{required:!1,tsType:{name:"string"},description:""},current:{required:!1,tsType:{name:"boolean"},description:`Posé automatiquement sur le dernier item.
La page courante n’est pas un lien.`,defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};const q="import { Breadcrumb, BreadcrumbItem } from 'd-ui';",$={title:"Components/Breadcrumb",component:s,args:{children:e.jsx("span",{})},argTypes:z},t={name:"Par défaut",parameters:j(q,`<Breadcrumb label="Fil d’Ariane">
    <BreadcrumbItem href="/">Accueil</BreadcrumbItem>
    <BreadcrumbItem href="/cours">Cours</BreadcrumbItem>
    <BreadcrumbItem>Mathématiques</BreadcrumbItem>
</Breadcrumb>`),render:(a,{globals:c})=>{const r=g(y(c.locale));return e.jsxs(s,{...a,label:r.label,children:[e.jsx(m,{href:"/",children:r.home}),e.jsx(m,{href:"/cours",children:r.courses}),e.jsx(m,{children:r.math})]})}},l={name:"Tailles",parameters:j(q,`<>
