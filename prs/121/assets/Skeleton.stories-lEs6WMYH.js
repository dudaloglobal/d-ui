...
</div>`),render:(t,{globals:a})=>{const n=o(r(a.locale));return e.jsx(d,{label:n.loading,children:e.jsxs("div",{className:"border-border rounded-lg border p-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(s,{shape:"text",width:"40%"}),e.jsx(s,{shape:"circle",size:24})]}),e.jsx("div",{className:"mt-4 flex items-end gap-2",children:[40,68,32,80,56,72].map((S,A)=>e.jsx(s,{height:S,width:"100%"},A))})]})})}},x={name:"Liste",parameters:l(i,`<div className="flex items-center gap-3" aria-busy="true">
...
}`,...(B=(O=x.parameters)==null?void 0:O.docs)==null?void 0:B.source}}};var E,I,q;u.parameters={...u.parameters,docs:{...(E=u.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Témoignage',
