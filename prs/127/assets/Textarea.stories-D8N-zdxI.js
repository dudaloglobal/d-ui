...
/>`),render:(l,{globals:a})=>{const e=n(s(a.locale));return t.jsx(u,{label:e.textareaLabel,maxLength:200,countMessage:De(e)})}},f={name:"Halo de focus",parameters:o(`<Textarea
    ...
    focusShadow
    onChange={(event) => setValue(event.target.value)}
/>`),render:(l,{globals:a})=>{const e=n(s(a.locale));return t.jsx(u,{label:e.textareaLabel,focusShadow:!0})}};var A,J,W;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'Par défaut',
...
}`,...(W=(J=c.parameters)==null?void 0:J.docs)==null?void 0:W.source}}};var U,G,K;d.parameters={...d.parameters,docs:{...(U=d.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'Désactivé',
  parameters: textareaSource(\`<Textarea
    label="Libellé de la zone de texte"
    value={value}
