import{r as N,j as e,h as k,y as g,d as E}from"./iframe-Dd_2AHQ-.js";import{D as A}from"./arg-types-rAVuTB0x.js";import{c as x}from"./docs-source-C_O40UCi.js";import{I as h}from"./IconButton-B3o9jOWe.js";import{P as M}from"./Popover-BDfJpDcE.js";const J=["💖","👍","🎉","👏","😂","😮","😢","🤔","👎"],V={"💖":"Cœur étincelant","👍":"Pouce en l’air","🎉":"Cotillons","👏":"Applaudissements","😂":"Larmes de joie","😮":"Surprise","😢":"Larmes","🤔":"Réflexion","👎":"Pouce en bas"};function i({children:a,onSelect:n,placement:o="top",open:u,defaultOpen:S=!1,onOpenChange:l,disabled:c=!1,radius:w,className:C,labels:m,"aria-label":B="Réactions"}){const I=u!==void 0,[O,D]=N.useState(S),L=c?!1:u??O,p=r=>{c&&r||(I||D(r),l==null||l(r))},_=r=>{n==null||n(r),p(!1)},q=r=>(m==null?void 0:m[r])??V[r];return e.jsx(M,{unstyled:!0,arrow:!1,trapFocus:!0,placement:o,open:L,onOpenChange:p,disabled:c,radius:w,"aria-label":B,className:k("d-ui-emoji-popover",C),content:e.jsx("div",{className:"flex items-center",children:J.map(r=>e.jsx("button",{type:"button",className:"d-ui-emoji-popover-btn","aria-label":q(r),onClick:()=>_(r),children:e.jsx("span",{"aria-hidden":!0,children:r})},r))}),children:a})}i.__docgenInfo={description:"",methods:[],displayName:"EmojiPopover",props:{children:{required:!0,tsType:{name:"ReactElement"},description:""},onSelect:{required:!1,tsType:{name:"signature",type:"function",raw:"(emoji: ReactionEmoji) => void",signature:{arguments:[{type:{name:"unknown[number]",raw:"(typeof REACTION_EMOJIS)[number]"},name:"emoji"}],return:{name:"void"}}},description:""},placement:{required:!1,tsType:{name:"union",raw:`| 'top'
| 'top-start'
| 'top-end'
| 'bottom'
| 'bottom-start'
