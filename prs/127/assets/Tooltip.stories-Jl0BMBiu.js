import{r as s,j as e,h as ve,y as l,d as i}from"./iframe-Dd_2AHQ-.js";import{M as he}from"./arg-types-rAVuTB0x.js";import{c as d,b as Te}from"./docs-source-C_O40UCi.js";import{B as c}from"./Button-BAUgmb3L.js";import{A as Se,u as Be,a as be,t as xe,B as Ee,c as je,d as Ae,e as Ce,g as Oe,F as _e,O,f as we,i as De,o as Me,j as Re,s as Pe,k as Ne,l as Le,m as _}from"./floating-CfwWRgzA.js";import{c as Fe}from"./cornerRadius-B4XFh-_5.js";const qe=200;function n({content:r,children:o,placement:t="top",open:a,defaultOpen:X=!1,onOpenChange:b,delayMs:Z=qe,disabled:B=!1,radius:$="md",className:ee}){const E=s.useId(),j=s.useRef(null),te=Se(),[oe,re]=s.useState(X),[ne,ae]=s.useState(null),se=a!==void 0,x=B?!1:a??oe,le=p=>{B&&p||(se||re(p),b==null||b(p))},{refs:A,floatingStyles:ie,context:m}=Be({open:x,onOpenChange:le,placement:t,middleware:[Me(O+4),Re({padding:_,fallbackAxisSideDirection:"start"}),Pe({padding:_}),Ne({element:j,padding:6})],whileElementsMounted:De}),ce=be(ne),C=Le(ce),pe=xe(m,{enabled:!B,move:!1,delay:{open:te?0:Z,close:0}}),de=Ee(m,{enabled:!B}),ue=je(m,{ancestorScroll:!0}),me=Ae(m,{role:"tooltip"}),{getReferenceProps:ye,getFloatingProps:ge}=Ce([pe,de,ue,me]),fe=s.isValidElement(o)?s.cloneElement(o,ye({"aria-describedby":x?E:void 0})):o;return e.jsxs(e.Fragment,{children:[e.jsx("span",{ref:p=>{A.setReference(p),ae(p)},className:"inline-flex max-w-full",children:fe}),x?e.jsx(Oe,{children:e.jsxs("div",{ref:A.setFloating,style:ie,...ge(),...C,id:E,className:ve(C.className,"pointer-events-none max-w-xs bg-fg px-2 py-1 text-sm text-bg shadow-md",Fe[$],ee),children:[r,e.jsx(_e,{ref:j,context:m,width:we,height:O,className:"d-ui-tooltip-arrow","data-d-ui-tooltip-arrow":"","aria-hidden":!0})]})}):null]})}n.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"ReactNode"},description:"Contenu non interactif. Ne pas y placer de bouton, lien ou champ."},children:{required:!0,tsType:{name:"ReactElement"},description:"Déclencheur unique (focusable). `Button` n’expose pas de ref : un wrapper sert de référence."},placement:{required:!1,tsType:{name:"union",raw:`| 'top'
| 'top-start'
| 'top-end'
| 'bottom'
| 'bottom-start'
...
return (
    ...
    <Button variant="secondary">Aide</Button>
</Tooltip>`),render:(r,{globals:o})=>{const t=l(i(o.locale));return e.jsx(n,{...r,content:t.tip,radius:"xl",defaultOpen:!0,delayMs:0,children:e.jsx(c,{variant:"secondary",children:t.help})})}};var w,D,M;y.parameters={...y.parameters,docs:{...(w=y.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Par défaut',
  args: {
...
}`,...(M=(D=y.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};var R,P,N;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'Placement',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
