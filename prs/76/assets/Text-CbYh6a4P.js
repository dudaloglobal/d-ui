import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as o}from"./index-AGuS8-Lw.js";import{M as t,C as i,A as c}from"./index-CxtFEFAj.js";import{T as d,D as l,S as a,a as x,W as h}from"./Text.stories-DpZGqbZ5.js";import"./index-DQxMMF7O.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B_2c9ucO.js";import"./index-DTrdMgma.js";import"./index-DgH-xKnr.js";import"./index-Bhqu_tAV.js";import"./docs-source-TRj_OXTg.js";import"./cx-BmrDAEIN.js";import"./Text-q3dk7SM8.js";function r(n){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:d}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"tone"})," est une prop, jamais un ",e.jsx(s.code,{children:"className"}),". ",e.jsx(s.code,{children:"cx()"})," ne résout pas les conflits Tailwind : ",e.jsx(s.code,{children:'className="text-slate-400"'})," laisserait ",e.jsx(s.code,{children:"text-fg"})," gagner. ",e.jsx(s.code,{children:"muted"})," reste au-dessus de 4.5:1 dans les deux thèmes."]}),`
`,e.jsx(i,{of:x}),`
...
`,e.jsx(c,{of:d,include:["as","size","tone","weight"]})]})}function C(n={}){const{wrapper:s}={...o(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(r,{...n})}):r(n)}export{C as default};
