import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as c}from"./index-AGuS8-Lw.js";import{M as d,C as s,A as a}from"./index-CxtFEFAj.js";import{S as l,K as o,C as t}from"./SkipLink.stories-BHUz9B_L.js";import"./index-DQxMMF7O.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-B_2c9ucO.js";import"./index-DTrdMgma.js";import"./index-DgH-xKnr.js";import"./index-Bhqu_tAV.js";import"./docs-source-TRj_OXTg.js";import"./cx-BmrDAEIN.js";function r(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...c(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:l}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"href"})," pointe un identifiant déjà focusable, en général ",e.jsx(n.code,{children:'<main id="main" tabIndex={-1}>'}),". Le composant ",e.jsx(n.strong,{children:"ne pose pas"})," ",e.jsx(n.code,{children:"tabIndex"})," sur la cible : c’est à l’application de rendre le landmark focusable. Si la cible est absente ",e.jsx(n.strong,{children:"ou"})," ne peut pas recevoir le focus, le clic n’est pas annulé : le navigateur suit l’ancre."]}),`
`,e.jsx(s,{of:t}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Omettre ",e.jsx(n.code,{children:"tabIndex={-1}"})," sur ",e.jsx(n.code,{children:"main"})," (le focus n’ira pas ; le saut d’ancre natif prend le relais)"]}),`
