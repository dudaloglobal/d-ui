import{r as p,j as n,a2 as i,d as t}from"./iframe-B7t-M21q.js";import{w as Le}from"./arg-types-YVnHkuEO.js";import{c as u}from"./docs-source-C_O40UCi.js";import{C as Ae}from"./Calendar-B5qhMswO.js";import{c as Ie,j as Me,p as $e}from"./calendarDate-jCkUcsyL.js";import{u as Ee}from"./useFieldControl-BVC9-yw5.js";import{P as Ne}from"./Popover-DEVnHNek.js";import{T as Oe}from"./TextInput-D--KmgBO.js";import{p as Re,P as _e,C as Je,f as Ke,a as Be}from"./pickerChrome-CMkUVJm-.js";function o({size:l="md",label:a,helper:e,error:s,invalid:ie=!1,disabled:ue=!1,required:de=!1,fullWidth:me=!0,clearable:pe=!0,name:A,locale:c="fr",placeholder:ye,value:y,defaultValue:I=null,onValueChange:j,minValue:M,maxValue:$,isDateUnavailable:E,today:be,open:N,defaultOpen:fe=!1,onOpenChange:S,openCalendarLabel:O="Ouvrir le calendrier",clearLabel:ge="Effacer",invalidMessage:ve="Date invalide.",className:he}){const P=Ee(),ke=p.useId(),De=P.id??ke,m=!!(ue||P.disabled),[Pe,qe]=p.useState(I),[Te,Ce]=p.useState(fe),[R,x]=p.useState(()=>L(y??I,c)),[_,q]=p.useState(!1),T=y!==void 0,V=T?y:Pe,je=m?!1:N??Te;p.useEffect(()=>{T&&x(L(y,c))},[T,y,c]);function w(r){m&&r||(N===void 0&&Ce(r),S==null||S(r))}function z(r,C=L(r,c)){T||qe(r),x(C),q(!1),j==null||j(r)}function Se(){const r=Be(R,c);if(r===void 0){q(!0);return}if(r&&$e(r,{minValue:M,maxValue:$,isDateUnavailable:E})){q(!0);return}z(r)}const xe=!!(ie||P["aria-invalid"]||_||s),Ve=ye??(c.toLowerCase().startsWith("en")?"MM/DD/YYYY":"JJ/MM/AAAA"),we=_?s??ve:s;function ze(r){r.key==="ArrowDown"&&r.altKey&&(r.preventDefault(),w(!0))}return n.jsxs(n.Fragment,{children:[A?n.jsx("input",{type:"hidden",name:A,value:V?Ie(V):""}):null,n.jsx(Oe,{id:De,size:l,label:a,helper:e,error:we,invalid:xe,disabled:m,required:P.required??de,fullWidth:me,clearable:pe,clearLabel:ge,placeholder:Ve,autoComplete:"off",inputMode:"numeric",value:R,className:he,onChange:r=>{x(r.target.value),q(!1)},onBlur:r=>{const C=r.relatedTarget;C instanceof HTMLElement&&C.getAttribute("aria-haspopup")||Se()},onKeyDown:ze,onClear:()=>z(null),suffix:n.jsx(Ne,{open:je,onOpenChange:w,trapFocus:!0,unstyled:!0,arrow:!1,placement:"bottom-start",disabled:m,"aria-label":O,className:Re,content:n.jsx(Ae,{size:l==="lg"?"md":"sm",locale:c,today:be,value:V,minValue:M,maxValue:$,isDateUnavailable:E,disabled:m,onValueChange:r=>{Me(r)||(z(r),w(!1))}}),children:n.jsx(_e,{label:O,disabled:m,children:n.jsx(Je,{})})})})]})}function L(l,a){return l?Ke(l,a):""}o.__docgenInfo={description:"Champ date : saisie au clavier + Calendar dans un Popover.\n\nValeur civile `{ year, month, day }`, pas de fuseau.",methods:[],displayName:"DatePicker",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},label:{required:!1,tsType:{name:"ReactNode"},description:""},helper:{required:!1,tsType:{name:"ReactNode"},description:""},error:{required:!1,tsType:{name:"ReactNode"},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},required:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},clearable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},name:{required:!1,tsType:{name:"string"},description:""},locale:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'fr'",computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:""},value:{required:!1,tsType:{name:"union",raw:"CalendarDate | null",elements:[{name:"signature",type:"object",raw:`{
...
}`,...(H=(G=g.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var Q,X,Z;v.parameters={...v.parameters,docs:{...(Q=v.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: 'Désactivé',
...
}`,...(Z=(X=v.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};var ee,ae,re;h.parameters={...h.parameters,docs:{...(ee=h.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  name: 'Invalide',
