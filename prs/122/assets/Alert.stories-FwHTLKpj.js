...
>
    Nouvelle fonctionnalité disponible.
</Alert>`),render:(e,{globals:n})=>{const a=l(c(n.locale));return r.jsx(o,{...e,icon:r.jsx(i,{as:y,size:"md"}),actions:r.jsx(ie,{size:"sm",variant:"ghost",children:a.learnMore}),children:a.featureBody})}};var I,k,L;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'Par défaut',
  args: {
    variant: 'info'
  },
...
}`,...(L=(k=p.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};var C,z,T;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Variantes',
