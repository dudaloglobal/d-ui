import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as u}from"./cx-2dOUpm6k.js";import{T as s}from"./Text-CLY2twGo.js";function t({orientation:r="horizontal",label:o,className:l,...c}){const d=o?{role:"separator","aria-orientation":r,"aria-label":o}:{role:"none","aria-hidden":!0},p=r==="horizontal"?"h-px w-full":"w-px self-stretch min-h-4";return r==="vertical"?e.jsx("div",{...d,className:u("bg-border-subtle",p,l),...c}):e.jsx("hr",{...d,className:u("bg-border-subtle border-0",p,l),...c})}t.__docgenInfo={description:`Filet de séparation.
