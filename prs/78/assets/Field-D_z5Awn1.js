import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as s}from"./index-AGuS8-Lw.js";import{M as l}from"./index-ClkGpp38.js";import"./index-DQxMMF7O.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-zGi5P2RF.js";import"./index-DTrdMgma.js";import"./index-DgH-xKnr.js";import"./index-Bhqu_tAV.js";function i(r){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Fondations/Champs de formulaire"}),`
...
`,e.jsxs(n.p,{children:[e.jsxs(n.strong,{children:[e.jsx(n.code,{children:"Label"})," doit rester le premier enfant du ",e.jsx(n.code,{children:"Field group"}),"."]})," Une ",e.jsx(n.code,{children:"legend"}),` ne
nomme son `,e.jsx(n.code,{children:"fieldset"}),` que si elle en est le premier élément ; placée plus bas,
elle devient un texte ordinaire et le groupe perd son nom accessible.`]}),`
`,e.jsxs(n.p,{children:[e.jsxs(n.strong,{children:[e.jsx(n.code,{children:"required"})," ne descend pas sur les contrôles d'un groupe."]}),` Sur une case à
cocher, `,e.jsx(n.code,{children:"required"}),` veut dire « cette case-ci doit être cochée » : le poser sur
chacune exigerait de toutes les cocher, alors que l'intention est « au moins un
choix ». Dans un groupe, `,e.jsx(n.code,{children:"required"}),` ne pilote donc que l'astérisque de la
...
message étant aussi cité par `,e.jsx(n.code,{children:"aria-describedby"}),`, il peut être annoncé deux
