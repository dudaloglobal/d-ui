...
import { Icon } from 'd-ui';`,U={title:"Components/Icon",component:a,argTypes:_,args:{as:t}},l={name:"Par défaut",parameters:i(f,"<Icon as={BellIcon} />")},m={name:"Tailles",parameters:i(f,`<>
  ...
  <Icon as={BellIcon} size="sm" />
  <Icon as={BellIcon} size="lg" />
</>`),render:()=>e.jsxs("div",{className:"text-fg flex items-end gap-4",children:[e.jsx(a,{as:t,size:"sm"}),e.jsx(a,{as:t,size:"md"}),e.jsx(a,{as:t,size:"lg"})]})},u={name:"Nomée",args:{as:h,label:"Supprimer définitivement"},parameters:i(`import { TrashIcon } from '@heroicons/react/24/outline';
import { Icon } from 'd-ui';`,'<Icon as={TrashIcon} label="Supprimer définitivement" />'),render:(o,{globals:n})=>{const s=G(A(n.locale));return e.jsx(a,{...o,as:h,label:s.deleteForever})}},I={name:"Dans un bouton",parameters:i(`import { ArrowRightIcon, ChevronDownIcon, TrashIcon } from '@heroicons/react/24/outline';
...
</>`),render:(o,{globals:n})=>{const s=G(A(n.locale));return e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(g,{icon:e.jsx(a,{as:W,size:"sm"}),iconPosition:"end",children:s.continue}),e.jsx(g,{variant:"secondary",icon:e.jsx(a,{as:J,size:"sm"}),children:s.filter}),e.jsx(F,{icon:e.jsx(a,{as:h,size:"sm"}),"aria-label":s.delete})]})}};var x,b,v;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Par défaut',
