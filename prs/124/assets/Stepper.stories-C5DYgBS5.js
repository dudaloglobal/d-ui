import{j as s,i,w as n,d as p}from"./iframe-CVN8O8y4.js";import{E as Ze}from"./arg-types-D5LRc10N.js";import{c as o}from"./docs-source-C_O40UCi.js";import{c as D,d as I,u as Xe,U as Je,a as Qe}from"./uiScale-XvgKbea-.js";import{B as Ye,a as H}from"./Breadcrumb-izm6cpb_.js";import{B as M}from"./Button-ZDdT4YL0.js";import{P as es}from"./Progress-B0A-lFtr.js";import{T as V}from"./Text-B2-FHRi5.js";import{T as ss}from"./TextInput-D_n2Xz7N.js";import{V as U}from"./VisuallyHidden-D5oc46DR.js";import{L as W}from"./Link-sxveVjGw.js";const as={complete:"Completed",current:"Current step",upcoming:"Upcoming"},rs={circles:2,bullets:1.25,panels:0},ts={xxs:.625,xs:.75,s:.875,m:1,l:1.125,xl:1.3125,xxl:1.5},ls={xxs:.625,xs:.75,s:.8125,m:.875,l:1,xl:1.125,xxl:1.25};function ns(a,r){return a<r?"complete":a===r?"current":"upcoming"}function ps(a,r){return a==="complete"?i(Xe[r],I[r]):a==="current"?i("bg-bg",D[r],I[r]):"bg-bg text-fg-muted border-border"}function G(a,r){return a==="complete"?"text-fg":a==="current"?i(D[r],"font-medium"):"text-fg-muted"}function K({className:a}){return s.jsx("svg",{viewBox:"0 0 16 16",fill:"none",stroke:"currentColor",strokeWidth:"2.25",strokeLinecap:"round",strokeLinejoin:"round",className:i("size-[1.1em]",a),"aria-hidden":"true",focusable:"false",children:s.jsx("path",{d:"M3.5 8.5l3 3 6-6"})})}function c({steps:a,current:r,variant:e="circles",orientation:t="horizontal",size:x="m",color:m="brand",label:He,hideLabels:Ve=!1,bordered:$e=!1,statusLabels:we=as,className:Oe,style:qe,...Fe}){const E=t==="vertical",$=e==="panels",w=Math.min(Math.max(Math.trunc(r),0),Math.max(a.length-1,0)),Me={"--d-ui-step-marker":`${rs[e]*ts[x]}rem`,fontSize:`${ls[x]}rem`};return s.jsx("ol",{...Fe,"aria-label":He,style:{...Me,...qe},className:i("flex",E?"flex-col":"flex-row items-start",$?"gap-3":null,Oe),children:a.map((b,g)=>{const l=ns(g,w),Ue=g===a.length-1,We=we[l],O=e==="bullets"&&Ve,Ge=b.href?s.jsx(W,{href:b.href,children:b.label}):s.jsx("span",{className:G(l,m),children:b.label}),q=s.jsxs(s.Fragment,{children:[O?b.href?null:s.jsx(U,{children:b.label}):Ge,s.jsx(U,{children:` — ${We}`}),b.description&&e!=="bullets"?s.jsx("span",{className:"text-fg-muted mt-0.5 block",children:b.description}):null]});if($)return s.jsxs("li",{"aria-current":l==="current"?"step":void 0,className:i("flex-1 px-4 py-3",$e?"rounded-md border":"border-t-4",l==="upcoming"?"border-border":I[m]),children:[s.jsxs("span",{className:i("flex items-center gap-1.5 text-[0.8em] font-medium uppercase",G(l,m)),children:[l==="complete"?s.jsx(K,{className:"size-[0.95em]"}):null,`${g+1}`.padStart(2,"0")]}),q]},g);const F=e==="bullets"?s.jsx("span",{"data-d-ui-step-marker":"",className:"grid size-[var(--d-ui-step-marker)] shrink-0 place-items-center",children:s.jsx("span",{className:i("block rounded-full border-2",l==="current"?"size-[calc(var(--d-ui-step-marker)/1.5)]":"size-[calc(var(--d-ui-step-marker)/2)]",l==="complete"?i("bg-current",D[m],I[m]):"bg-bg",l==="current"?I[m]:null,l==="upcoming"?"border-border":null)})}):s.jsx("span",{"data-d-ui-step-marker":"",className:i("grid size-[var(--d-ui-step-marker)] shrink-0 place-items-center rounded-full font-medium",l==="current"?"border-[3px]":"border-2",ps(l,m)),children:l==="complete"?s.jsx(K,{}):g+1}),Ke=O&&b.href?s.jsx(W,{href:b.href,className:"inline-flex min-h-6 min-w-6 items-center justify-center no-underline","aria-label":b.label,children:F}):F;return s.jsxs("li",{"aria-current":l==="current"?"step":void 0,className:i("relative flex",E?"flex-row gap-3 pb-6 last:pb-0":"flex-1 flex-col items-start gap-2"),children:[Ue?null:s.jsx("span",{"aria-hidden":"true",className:i(g<w?i("bg-current",D[m]):"bg-border","absolute",E?"top-[var(--d-ui-step-marker)] bottom-0 left-[calc(var(--d-ui-step-marker)/2-1px)] w-0.5":"left-[var(--d-ui-step-marker)] right-0 top-[calc(var(--d-ui-step-marker)/2-1px)] h-0.5")}),Ke,s.jsx("span",{className:E?"min-w-0":"block",children:q})]},g)})})}c.__docgenInfo={description:'Suite d\'étapes ordonnées, avec l\'étape en cours.\n\nRend une `<ol>` : l\'ordre **est** l\'information. L\'étape en cours porte\n`aria-current="step"`, et chaque étape annonce son statut en toutes lettres\nvia un `VisuallyHidden`.\n\nLe statut se voit aussi **sans percevoir les couleurs** (WCAG 1.4.1) : une\nétape terminée porte une coche (`circles`, `panels`) ou une pastille pleine\n(`bullets`), une étape à venir un contour creux.\n\nSi les étapes sont des liens, enveloppez le composant dans un `<nav>` : c\'est\nalors de la navigation, et ce choix appartient à la page.\n\n`orientation="vertical"` avec `variant="circles"` donne la frise verticale —\nla même liste, pas un composant de plus. Pour la forme à chevrons, le design\nsystem a déjà `Breadcrumb` : la dupliquer ici donnerait deux conventions\n(`aria-current="step"` contre `"page"`) pour un seul motif visuel.',methods:[],displayName:"Stepper",props:{variant:{defaultValue:{value:"'circles'",computed:!1},required:!1},orientation:{defaultValue:{value:"'horizontal'",computed:!1},required:!1},size:{defaultValue:{value:"'m'",computed:!1},required:!1},color:{defaultValue:{value:"'brand'",computed:!1},required:!1},hideLabels:{defaultValue:{value:"false",computed:!1},required:!1},bordered:{defaultValue:{value:"false",computed:!1},required:!1},statusLabels:{defaultValue:{value:`{
  complete: 'Completed',
...
}`,...(Ie=(Ae=R.parameters)==null?void 0:Ae.docs)==null?void 0:Ie.source}}};var ze,Ee,De;A.parameters={...A.parameters,docs:{...(ze=A.parameters)==null?void 0:ze.docs,source:{originalSource:`{
