...
import { Button, Icon, Menu, MenuItem, MenuSeparator } from 'd-ui';`,Gn="import { Button, ContextMenu, Menu, MenuItem, MenuSeparator } from 'd-ui';",Un={title:"Components/Menu",component:l,argTypes:cn,args:{trigger:e.jsx("span",{}),children:e.jsx("span",{})}},L={name:"Par défaut",parameters:h(q,`<Menu label="Actions du devoir" trigger={<Button variant="secondary">Actions</Button>}>
...
}`,...(ze=(Pe=V.parameters)==null?void 0:Pe.docs)==null?void 0:ze.source}}};const Yn=["Default","TriggerVariants","Items","Shortcuts","DisabledItems","Submenu","Context","Sizes","Disabled"],ut=Object.freeze(Object.defineProperty({__proto__:null,Context:_,Default:L,Disabled:V,DisabledItems:F,Items:P,Shortcuts:z,Sizes:$,Submenu:O,TriggerVariants:E,__namedExportsOrder:Yn,default:Un},Symbol.toStringTag,{value:"Module"}));export{_ as C,L as D,P as I,ut as M,z as S,E as T,F as a,O as b,$ as c,V as d};
