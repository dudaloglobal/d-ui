import{p as s,q as l,d as p,j as e}from"./iframe-m85d2-d1.js";import{e as y}from"./arg-types-C3uIi5KS.js";import{c as f}from"./docs-source-C_O40UCi.js";import{B as h}from"./Button-C7UWra0G.js";const B={title:"Foundations/ThemeProvider",component:s,args:{children:null},argTypes:y,parameters:{controls:{include:["mode","className"]}}},r={name:"Surcharge de marque",parameters:f("import { Button, ThemeProvider } from 'd-ui';",`<ThemeProvider
  tokens={{
    brand: '#7c3aed',
    brandHover: '#6d28d9',
    onBrand: '#ffffff',
