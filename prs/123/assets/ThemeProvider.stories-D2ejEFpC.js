import{z as s,B as l,d as p,j as e}from"./iframe-C18N9SQO.js";import{q as y}from"./arg-types-C0FEJ_j7.js";import{c as f}from"./docs-source-C_O40UCi.js";import{B as h}from"./Button-3_Ffbeop.js";const B={title:"Foundations/ThemeProvider",component:s,args:{children:null},argTypes:y,parameters:{controls:{include:["mode","className"]}}},r={name:"Surcharge de marque",parameters:f("import { Button, ThemeProvider } from 'd-ui';",`<ThemeProvider
  tokens={{
    brand: '#7c3aed',
    brandHover: '#6d28d9',
    onBrand: '#ffffff',
