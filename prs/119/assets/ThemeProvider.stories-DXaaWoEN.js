import{w as s,x as l,d as p,j as e}from"./iframe-Cg6bt1aJ.js";import{j as y}from"./arg-types-BNJ7MSgH.js";import{c as f}from"./docs-source-C_O40UCi.js";import{B as h}from"./Button-DV2PshCF.js";const B={title:"Foundations/ThemeProvider",component:s,args:{children:null},argTypes:y,parameters:{controls:{include:["mode","className"]}}},r={name:"Surcharge de marque",parameters:f("import { Button, ThemeProvider } from 'd-ui';",`<ThemeProvider
  tokens={{
    brand: '#7c3aed',
    brandHover: '#6d28d9',
    onBrand: '#ffffff',
