...
`).map(e=>`    ${e}`).join(`
`)}
);`)}function u({defaultValue:l,value:a,onChange:e,...L}){const[b,i]=y.useState(()=>_(a??l));return t.jsx(M,{...L,value:b,onChange:x=>{i(x.target.value),e==null||e(x)}})}const Re={title:"Components/Textarea",component:M,argTypes:Se,parameters:{controls:{include:["size","label","helper","placeholder","invalid","valid","disabled","required","clearable","showCount","fullWidth","focusShadow","maxLength","rows"]}}},c={name:"Par défaut",parameters:o(`<Textarea
