import{r as s,j as r,a4 as v,d as k}from"./iframe-Cg6bt1aJ.js";import{D as je}from"./arg-types-BNJ7MSgH.js";import{c as h}from"./docs-source-C_O40UCi.js";import{u as He}from"./useFieldControl-DYInY4Lx.js";import{P as Se}from"./Popover-D2KRnYZG.js";import{T as Ve}from"./TextInput-D3NzSsNE.js";import{e as J,p as Ce,P as Le,g as ze,h as De,j as we}from"./pickerChrome-BVAOlIr6.js";import{T as N}from"./TimeSpinner-CXgoFWxY.js";function t({size:l="md",label:n,helper:a,error:P,invalid:Q=!1,disabled:X=!1,required:Y=!1,fullWidth:Z=!0,clearable:ee=!0,name:C,placeholder:re="HH:mm",value:u,defaultValue:L=null,onValueChange:x,minValue:ae,maxValue:le,open:z,defaultOpen:ne=!1,onOpenChange:j,openTimeLabel:D="Ouvrir le sélecteur d’heure",hourLabel:te="Heure",minuteLabel:ie="Minutes",incrementHourLabel:se="Augmenter l’heure",decrementHourLabel:ue="Diminuer l’heure",incrementMinuteLabel:oe="Augmenter les minutes",decrementMinuteLabel:me="Diminuer les minutes",clearLabel:de="Effacer",invalidMessage:ce="Heure invalide.",className:pe}){const p=He(),fe=s.useId(),be=p.id??fe,i=!!(X||p.disabled),[ye,Te]=s.useState(L),[ge,ve]=s.useState(ne),[w,H]=s.useState(()=>V(u??L)),[I,f]=s.useState(!1),b=u!==void 0,S=b?u:ye,ke=i?!1:z??ge,y=S??{hour:0,minute:0};s.useEffect(()=>{b&&H(V(u))},[b,u]);function $(e){i&&e||(z===void 0&&ve(e),j==null||j(e))}function T(e,g=V(e)){b||Te(e),H(g),f(!1),x==null||x(e)}function he(){const e=De(w);if(e===void 0){f(!0);return}if(e&&we(e,{minValue:ae,maxValue:le})){f(!0);return}T(e)}const qe=!!(Q||p["aria-invalid"]||I||P),Pe=I?P??ce:P;function xe(e){e.key==="ArrowDown"&&e.altKey&&(e.preventDefault(),$(!0))}return r.jsxs(r.Fragment,{children:[C?r.jsx("input",{type:"hidden",name:C,value:S?J(S):""}):null,r.jsx(Ve,{id:be,size:l,label:n,helper:a,error:Pe,invalid:qe,disabled:i,required:p.required??Y,fullWidth:Z,clearable:ee,clearLabel:de,placeholder:re,autoComplete:"off",inputMode:"numeric",value:w,className:pe,onChange:e=>{H(e.target.value),f(!1)},onBlur:e=>{const g=e.relatedTarget;g instanceof HTMLElement&&g.getAttribute("aria-haspopup")||he()},onKeyDown:xe,onClear:()=>T(null),suffix:r.jsx(Se,{open:ke,onOpenChange:$,trapFocus:!0,unstyled:!0,arrow:!1,placement:"bottom-start",disabled:i,"aria-label":D,className:Ce,content:r.jsxs("div",{className:"flex items-center gap-3 px-2",children:[r.jsx(N,{label:te,incrementLabel:se,decrementLabel:ue,value:y.hour,min:0,max:23,disabled:i,onChange:e=>T({hour:e,minute:y.minute})}),r.jsx("span",{"aria-hidden":!0,className:"text-lg font-medium",children:":"}),r.jsx(N,{label:ie,incrementLabel:oe,decrementLabel:me,value:y.minute,min:0,max:59,disabled:i,onChange:e=>T({hour:y.hour,minute:e})})]}),children:r.jsx(Le,{label:D,disabled:i,children:r.jsx(ze,{})})})})]})}function V(l){return l?J(l):""}t.__docgenInfo={description:"Champ heure : saisie `HH:mm` + spinbuttons accessibles dans un Popover.",methods:[],displayName:"TimePicker",props:{size:{required:!1,tsType:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'md'",computed:!1}},label:{required:!1,tsType:{name:"ReactNode"},description:""},helper:{required:!1,tsType:{name:"ReactNode"},description:""},error:{required:!1,tsType:{name:"ReactNode"},description:""},invalid:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},required:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},clearable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},name:{required:!1,tsType:{name:"string"},description:""},placeholder:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'HH:mm'",computed:!1}},value:{required:!1,tsType:{name:"union",raw:"ClockTime | null",elements:[{name:"signature",type:"object",raw:`{
