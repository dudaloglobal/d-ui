...
/>`),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(be,{...o,label:o.label??e.city,placeholder:e.search,...t(e),options:y(e)})}},$={name:"Sélection multiple",args:{options:[]},parameters:re(`<Combobox
    multiple
    label="Villes"
    placeholder="Rechercher"
    options={options}
    value={value}
    onValueChange={setValue}
/>`),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(be,{multiple:!0,label:e.cities,placeholder:e.search,defaultValue:["paris","lyon"],options:y(e),...t(e)})}},F={name:"Désactivé",args:{options:[]},parameters:C(S,'<Combobox label="Ville" options={options} defaultValue="paris" disabled />'),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:y(e),defaultValue:"paris",disabled:!0,...t(e)})}},B={name:"Invalide",args:{options:[]},parameters:C(S,'<Combobox label="Ville" options={options} invalid error="Ce champ est requis." />'),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:y(e),invalid:!0,error:e.error,...t(e)})}},P={name:"Requis",args:{options:[]},parameters:re(`<Combobox
    label="Ville"
    required
    options={options}
    value={value}
...
/>`),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:ka(e),placeholder:e.search,...t(e)})}};function Ea({copy:o}){const[s,e]=b.useState(["lyon"]),[i,u]=b.useState(""),[V,L]=b.useState(_a(o)),f=i.trim(),k=f.length>0&&!se(V).some(n=>String(n.label).toLowerCase()===f.toLowerCase()),te=()=>{const n={value:f.toLowerCase(),label:f,description:o.customCity};L(j=>[...j,n]),e(j=>[...j,n.value]),u("")};return a.jsx(r,{multiple:!0,label:o.cities,placeholder:o.search,options:V,value:s,onValueChange:n=>e(Array.isArray(n)?n:[n]),onSearch:u,filter:"auto",...t(o),renderOption:n=>a.jsxs("span",{className:"flex min-w-0 items-center gap-2",children:[a.jsx($e,{name:n.value}),a.jsxs("span",{className:"min-w-0",children:[a.jsx("span",{className:"block truncate font-medium",children:n.label}),n.description?a.jsx("span",{className:"mt-0.5 block truncate text-xs font-normal text-fg/60",children:n.description}):null]})]}),renderSectionTitle:n=>a.jsx("span",{className:"uppercase tracking-wide",children:n.label}),renderChip:n=>a.jsxs("span",{className:"inline-flex min-w-0 items-center gap-1.5",children:[a.jsx($e,{name:n.value}),a.jsx("span",{className:"truncate",children:n.label})]}),beforeOptions:k?a.jsxs("button",{type:"button",className:"flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-fg hover:bg-surface-hover",onMouseDown:n=>n.preventDefault(),onClick:te,children:[a.jsx(Ia,{}),o.create," « ",f," »"]}):null})}const U={name:"Rendu personnalisé",args:{options:[]},parameters:re(`<Combobox
    multiple
    label="Villes"
    options={options}
    renderOption={(option) => (
...
}`,...(Pe=(Be=A.parameters)==null?void 0:Be.docs)==null?void 0:Pe.source}}};var Ge,He,We;$.parameters={...$.parameters,docs:{...(Ge=$.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
...
}`,...(We=(He=$.parameters)==null?void 0:He.docs)==null?void 0:We.source}}};var Qe,Ke,Ue;F.parameters={...F.parameters,docs:{...(Qe=F.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  name: 'Désactivé',
  args: {
    options: []
  },
...
}`,...(Ue=(Ke=F.parameters)==null?void 0:Ke.docs)==null?void 0:Ue.source}}};var Je,Xe,Ye;B.parameters={...B.parameters,docs:{...(Je=B.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  name: 'Invalide',
  args: {
    options: []
  },
...
}`,...(Io=(_o=ee.parameters)==null?void 0:_o.docs)==null?void 0:Io.source}}};const za=["Default","Multiple","Disabled","Invalid","Required","Helper","Valid","Sizes","Group","Descriptions","Custom","Loading","LoadingMore","Empty","ListError","FilterTypes"],Wa=Object.freeze(Object.defineProperty({__proto__:null,Custom:U,Default:A,Descriptions:K,Disabled:F,Empty:Y,FilterTypes:ee,Group:Q,Helper:G,Invalid:B,ListError:Z,Loading:J,LoadingMore:X,Multiple:$,Required:P,Sizes:W,Valid:H,__namedExportsOrder:za,default:Da},Symbol.toStringTag,{value:"Module"}));export{Wa as C,A as D,Y as E,ee as F,Q as G,G as H,B as I,J as L,$ as M,P as R,W as S,H as V,K as a,U as b,F as c,X as d,Z as e};
