import{r as s,j as e,h as ve,z as l,d as i}from"./iframe-BTNaxqGu.js";import{Q as he}from"./arg-types-CcAGxubR.js";import{c as d,b as Te}from"./docs-source-C_O40UCi.js";import{B as c}from"./Button-CjHht5f9.js";import{e as Se,u as be,d as Be,w as xe,D as Ee,a as je,b as Ce,c as Ae,F as Oe,i as _e,O,j as we,k as De,l as Re,m as Me,s as Pe,n as Ne,o as Le,p as _}from"./floating-Cify4Q6n.js";import{c as Fe}from"./cornerRadius-B4XFh-_5.js";const qe=200;function n({content:r,children:o,placement:t="top",open:a,defaultOpen:X=!1,onOpenChange:B,delayMs:Z=qe,disabled:b=!1,radius:$="md",className:ee}){const E=s.useId(),j=s.useRef(null),te=Se(),[oe,re]=s.useState(X),[ne,ae]=s.useState(null),se=a!==void 0,x=b?!1:a??oe,le=p=>{b&&p||(se||re(p),B==null||B(p))},{refs:C,floatingStyles:ie,context:m}=be({open:x,onOpenChange:le,placement:t,middleware:[Re(O+4),Me({padding:_,fallbackAxisSideDirection:"start"}),Pe({padding:_}),Ne({element:j,padding:6})],whileElementsMounted:De}),ce=Be(ne),A=Le(ce),pe=xe(m,{enabled:!b,move:!1,delay:{open:te?0:Z,close:0}}),de=Ee(m,{enabled:!b}),ue=je(m,{ancestorScroll:!0}),me=Ce(m,{role:"tooltip"}),{getReferenceProps:ye,getFloatingProps:ge}=Ae([pe,de,ue,me]),fe=s.isValidElement(o)?s.cloneElement(o,ye({"aria-describedby":x?E:void 0})):o;return e.jsxs(e.Fragment,{children:[e.jsx("span",{ref:p=>{C.setReference(p),ae(p)},className:"inline-flex max-w-full",children:fe}),x?e.jsx(Oe,{children:e.jsxs("div",{ref:C.setFloating,style:ie,...ge(),...A,id:E,className:ve(A.className,"pointer-events-none max-w-xs bg-fg px-2 py-1 text-sm text-bg shadow-md",Fe[$],ee),children:[r,e.jsx(_e,{ref:j,context:m,width:we,height:O,className:"d-ui-tooltip-arrow","data-d-ui-tooltip-arrow":"","aria-hidden":!0})]})}):null]})}n.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"ReactNode"},description:"Contenu non interactif. Ne pas y placer de bouton, lien ou champ."},children:{required:!0,tsType:{name:"ReactElement"},description:"Déclencheur unique (focusable). `Button` n’expose pas de ref : un wrapper sert de référence."},placement:{required:!1,tsType:{name:"union",raw:`| 'top'
| 'top-start'
| 'top-end'
| 'bottom'
| 'bottom-start'
...
}`,...(N=(P=g.parameters)==null?void 0:P.docs)==null?void 0:N.source}}};var L,F,q;f.parameters={...f.parameters,docs:{...(L=f.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: 'Contrôlé',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(q=(F=f.parameters)==null?void 0:F.docs)==null?void 0:q.source}}};var V,I,H;v.parameters={...v.parameters,docs:{...(V=v.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Désactivé',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(z=(W=T.parameters)==null?void 0:W.docs)==null?void 0:z.source}}};var Q,J,K;S.parameters={...S.parameters,docs:{...(Q=S.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: 'Arrondi',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(K=(J=S.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const Ge=["Default","Placement","Controlled","Disabled","Collision","Portal","Radius"],Ke=Object.freeze(Object.defineProperty({__proto__:null,Collision:h,Controlled:f,Default:y,Disabled:v,Placement:g,Portal:T,Radius:S,__namedExportsOrder:Ge,default:Ie},Symbol.toStringTag,{value:"Module"}));export{f as C,y as D,g as P,S as R,Ke as T,v as a,h as b,T as c};
