import{D as t,d as l,j as r,r as x}from"./iframe-BTNaxqGu.js";import{u as X}from"./arg-types-CcAGxubR.js";import{c as i}from"./docs-source-C_O40UCi.js";import{U as Y,a as $}from"./uiScale-DBauGOvS.js";import{I as aa}from"./Icon-DkCoGqxg.js";import{T as n,a as ea}from"./Tag-C1gKqZyR.js";import{F as ra}from"./CheckIcon-CkY8-dtB.js";const g="import { Icon, Tag, TagGroup } from 'd-ui';",Q=["default","success","warning","danger","info","neutral"],sa={title:"Components/Tag",component:n,argTypes:X},p={name:"Par défaut",args:{variant:"default"},parameters:i(g,"<Tag>Nouveau</Tag>"),render:(e,{globals:s})=>{const a=t(l(s.locale));return r.jsx(n,{...e,children:a.defaultLabel})}},u={name:"Variantes",parameters:i(g,`<Tag variant="default">Nouveau</Tag>
