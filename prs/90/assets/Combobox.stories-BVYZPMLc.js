...
/>`),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:ka(e),placeholder:e.search,...t(e)})}};function Ea({copy:o}){const[s,e]=b.useState(["lyon"]),[i,u]=b.useState(""),[V,L]=b.useState(Ia(o)),f=i.trim(),k=f.length>0&&!se(V).some(n=>String(n.label).toLowerCase()===f.toLowerCase()),te=()=>{const n={value:f.toLowerCase(),label:f,description:o.customCity};L(j=>[...j,n]),e(j=>[...j,n.value]),u("")};return a.jsx(r,{multiple:!0,label:o.cities,placeholder:o.search,options:V,value:s,onValueChange:n=>e(Array.isArray(n)?n:[n]),onSearch:u,filter:"auto",...t(o),renderOption:n=>a.jsxs("span",{className:"flex min-w-0 items-center gap-2",children:[a.jsx(Fe,{name:n.value}),a.jsxs("span",{className:"min-w-0",children:[a.jsx("span",{className:"block truncate font-medium",children:n.label}),n.description?a.jsx("span",{className:"mt-0.5 block truncate text-xs font-normal text-fg/60",children:n.description}):null]})]}),renderSectionTitle:n=>a.jsx("span",{className:"uppercase tracking-wide",children:n.label}),renderChip:n=>a.jsxs("span",{className:"inline-flex min-w-0 items-center gap-1.5",children:[a.jsx(Fe,{name:n.value}),a.jsx("span",{className:"truncate",children:n.label})]}),beforeOptions:k?a.jsxs("button",{type:"button",className:"flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-fg hover:bg-surface-hover",onMouseDown:n=>n.preventDefault(),onClick:te,children:[a.jsx(_a,{}),o.create," « ",f," »"]}):null})}const U={name:"Rendu personnalisé",args:{options:[]},parameters:re(`<Combobox
    multiple
    label="Villes"
    options={options}
    renderOption={(option) => (
...
/>`),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(Ea,{copy:e})}},J={name:"Chargement",args:{options:[]},parameters:ne('<Combobox label="Ville" options={[]} listStatus="loading" defaultOpen />'),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:[],listStatus:"loading",loadingMessage:e.loading,defaultOpen:!0,...t(e)})}},X={name:"Chargement de la suite",args:{options:[]},parameters:ne('<Combobox label="Ville" options={options} listStatus="loadingMore" defaultOpen />'),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:y(e),listStatus:"loadingMore",loadingMessage:e.loadingMore,defaultOpen:!0,...t(e)})}},Y={name:"État vide",args:{options:[]},parameters:ne("<Combobox label=\"Ville\" options={[]} emptyMessage={(query) => query ? `Aucun résultat pour « ${query} »` : 'Aucune option'} defaultOpen />"),render:(o,{globals:s})=>{const e=d(m(s.locale));return a.jsx(r,{label:e.city,options:[],emptyMessage:i=>i?`${e.emptyQuery} « ${i} »`:e.empty,defaultOpen:!0,...t(e)})}},Z={name:"Erreur de liste",args:{options:[]},parameters:ne(`<Combobox
    label="Ville"
    options={[]}
    listStatus="error"
...
}`,...(Ue=(Ke=$.parameters)==null?void 0:Ke.docs)==null?void 0:Ue.source}}};var Je,Xe,Ye;B.parameters={...B.parameters,docs:{...(Je=B.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  name: 'Invalide',
  args: {
    options: []
  },
...
}`,...(Ye=(Xe=B.parameters)==null?void 0:Xe.docs)==null?void 0:Ye.source}}};var Ze,eo,oo;P.parameters={...P.parameters,docs:{...(Ze=P.parameters)==null?void 0:Ze.docs,source:{originalSource:`{
  name: 'Requis',
  args: {
    options: []
  },
...
}`,...(ho=(vo=U.parameters)==null?void 0:vo.docs)==null?void 0:ho.source}}};var Co,So,qo;J.parameters={...J.parameters,docs:{...(Co=J.parameters)==null?void 0:Co.docs,source:{originalSource:`{
  name: 'Chargement',
  args: {
    options: []
  },
...
}`,...(qo=(So=J.parameters)==null?void 0:So.docs)==null?void 0:qo.source}}};var Vo,jo,Ro;X.parameters={...X.parameters,docs:{...(Vo=X.parameters)==null?void 0:Vo.docs,source:{originalSource:`{
...
}`,...(Ro=(jo=X.parameters)==null?void 0:jo.docs)==null?void 0:Ro.source}}};var No,wo,Mo;Y.parameters={...Y.parameters,docs:{...(No=Y.parameters)==null?void 0:No.docs,source:{originalSource:`{
  name: 'État vide',
  args: {
    options: []
  },
...
}`,...(ko=(Lo=Z.parameters)==null?void 0:Lo.docs)==null?void 0:ko.source}}};var Oo,Io,_o;ee.parameters={...ee.parameters,docs:{...(Oo=ee.parameters)==null?void 0:Oo.docs,source:{originalSource:`{
...
}`,...(_o=(Io=ee.parameters)==null?void 0:Io.docs)==null?void 0:_o.source}}};const za=["Default","Multiple","Disabled","Invalid","Required","Helper","Valid","Sizes","Group","Descriptions","Custom","Loading","LoadingMore","Empty","ListError","FilterTypes"],Ha=Object.freeze(Object.defineProperty({__proto__:null,Custom:U,Default:A,Descriptions:K,Disabled:$,Empty:Y,FilterTypes:ee,Group:Q,Helper:G,Invalid:B,ListError:Z,Loading:J,LoadingMore:X,Multiple:F,Required:P,Sizes:W,Valid:H,__namedExportsOrder:za,default:Da},Symbol.toStringTag,{value:"Module"}));export{Ha as C,A as D,Y as E,ee as F,Q as G,G as H,B as I,J as L,F as M,P as R,W as S,H as V,K as a,U as b,$ as c,X as d,Z as e};
