import{r as s,j as e,f as ue,o as i,d as c}from"./iframe-Wq3C05Zi.js";import{x as me,c as h,e as ye}from"./docs-source-D4DylD1p.js";import{B as p}from"./Button-BkKoNCy4.js";import{n as ge,u as fe,a as ve,p as he,q as Te,c as Se,d as be,e as Be,g as xe,F as Ee,O as _,f as je,i as Ce,o as _e,j as Oe,s as we,k as Ae,l as De,m as O}from"./floating-DADufGJH.js";const Me=200;function a({content:r,children:o,placement:t="top",open:n,defaultOpen:z=!1,onOpenChange:b,delayMs:J=Me,disabled:S=!1,className:K}){const x=s.useId(),E=s.useRef(null),Q=ge(),[X,Z]=s.useState(z),[$,ee]=s.useState(null),te=n!==void 0,B=S?!1:n??X,oe=l=>{S&&l||(te||Z(l),b==null||b(l))},{refs:j,floatingStyles:re,context:d}=fe({open:B,onOpenChange:oe,placement:t,middleware:[_e(_+4),Oe({padding:O,fallbackAxisSideDirection:"start"}),we({padding:O}),Ae({element:E,padding:6})],whileElementsMounted:Ce}),ne=ve($),C=De(ne),ae=he(d,{enabled:!S,move:!1,delay:{open:Q?0:J,close:0}}),se=Te(d,{enabled:!S}),le=Se(d,{ancestorScroll:!0}),ie=be(d,{role:"tooltip"}),{getReferenceProps:ce,getFloatingProps:pe}=Be([ae,se,le,ie]),de=s.isValidElement(o)?s.cloneElement(o,ce({"aria-describedby":B?x:void 0})):o;return e.jsxs(e.Fragment,{children:[e.jsx("span",{ref:l=>{j.setReference(l),ee(l)},className:"inline-flex max-w-full",children:de}),B?e.jsx(xe,{children:e.jsxs("div",{ref:j.setFloating,style:re,...pe(),...C,id:x,className:ue(C.className,"pointer-events-none max-w-xs rounded-md bg-fg px-2 py-1 text-sm text-bg shadow-md",K),children:[r,e.jsx(Ee,{ref:E,context:d,width:je,height:_,className:"d-ui-tooltip-arrow","data-d-ui-tooltip-arrow":"","aria-hidden":!0})]})}):null]})}a.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"ReactNode"},description:"Contenu non interactif. Ne pas y placer de bouton, lien ou champ."},children:{required:!0,tsType:{name:"ReactElement"},description:"Déclencheur unique (focusable). `Button` n’expose pas de ref : un wrapper sert de référence."},placement:{required:!1,tsType:{name:"union",raw:`| 'top'
| 'top-start'
| 'top-end'
| 'bottom'
| 'bottom-start'
...
import { Button, Tooltip } from 'd-ui';`,Ne={title:"Components/Tooltip",component:a,argTypes:me,parameters:{controls:{include:["placement","delayMs","disabled","content"]}}},u={name:"Par défaut",args:{content:"Enregistrer (⌘S)",children:e.jsx("span",{})},parameters:h(T,`<Tooltip content="Enregistrer (⌘S)">
...
</>`),render:(r,{globals:o})=>{const t=i(c(o.locale));return e.jsx("div",{className:"flex flex-wrap items-center justify-center gap-4 py-12",children:["top","bottom","left","right"].map(n=>e.jsx(a,{content:t.tip,placement:n,delayMs:0,children:e.jsx(p,{variant:"secondary",children:t[n]})},n))})}},y={name:"Contrôlé",args:{content:"Enregistrer (⌘S)",children:e.jsx("span",{})},parameters:ye(Pe,`const [open, setOpen] = useState(false);
return (
    <Tooltip content="Enregistrer (⌘S)" open={open} onOpenChange={setOpen}>
        <Button variant="secondary">Aide</Button>
    </Tooltip>
);`),render:(r,{globals:o})=>{const t=i(c(o.locale));return e.jsx(Re,{label:t.help,tip:t.tip})}},g={name:"Désactivé",args:{content:"Enregistrer (⌘S)",children:e.jsx("span",{})},parameters:h(T,`<Tooltip content="Enregistrer (⌘S)" disabled>
    <Button variant="secondary">Aide</Button>
</Tooltip>`),render:(r,{globals:o})=>{const t=i(c(o.locale));return e.jsx(a,{content:t.tip,disabled:!0,delayMs:0,children:e.jsx(p,{variant:"secondary",children:t.help})})}},f={name:"Collision",args:{content:"Enregistrer (⌘S)",children:e.jsx("span",{})},parameters:h(T,`<Tooltip content="Enregistrer (⌘S)" placement="top">
    <Button variant="secondary">Aide</Button>
...
}`,...(L=(F=y.parameters)==null?void 0:F.docs)==null?void 0:L.source}}};var q,I,V;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'Désactivé',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(V=(I=g.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var H,G,Y;f.parameters={...f.parameters,docs:{...(H=f.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: 'Collision',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(Y=(G=f.parameters)==null?void 0:G.docs)==null?void 0:Y.source}}};var k,U,W;v.parameters={...v.parameters,docs:{...(k=v.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Portail',
  args: {
    content: 'Enregistrer (⌘S)',
    children: <span />
...
}`,...(W=(U=v.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};const Fe=["Default","Placement","Controlled","Disabled","Collision","Portal"],Ge=Object.freeze(Object.defineProperty({__proto__:null,Collision:f,Controlled:y,Default:u,Disabled:g,Placement:m,Portal:v,__namedExportsOrder:Fe,default:Ne},Symbol.toStringTag,{value:"Module"}));export{y as C,u as D,m as P,Ge as T,g as a,f as b,v as c};
