...
export const docsCopy = {
  ...
  intro: {
    ...
    itemComponents: {
      fr: 'les composants React (`Button`, `Text`, `Heading`, `Link`, `Icon`, `TextInput`, `Textarea`, `Checkbox`, `Radio`, `Switch`, `Select`, `Combobox`, `Tooltip`, `Popover`, `EmojiPopover`, `TimeAgo`, `ThemeProvider`, `SkipLink`, …)',
      en: 'the React components (`Button`, `Text`, `Heading`, `Link`, `Icon`, `TextInput`, `Textarea`, `Checkbox`, `Radio`, `Switch`, `Select`, `Combobox`, `Tooltip`, `Popover`, `EmojiPopover`, `TimeAgo`, `ThemeProvider`, `SkipLink`, …)',
    },
    itemCssVars: {
