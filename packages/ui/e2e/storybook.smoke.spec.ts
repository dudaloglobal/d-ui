...
test('component docs use Component | Dudalo Design System titles', async ({ page }) => {
  ...
  await page.goto('/?path=/docs/components-datatable--docs');
  await expect(page).toHaveTitle('DataTable | Dudalo Design System');
});
...
test('component docs H1 is the component name, like Link', async ({ page }) => {
  for (const { id, name } of [
    ...
    { id: 'components-datatable--docs', name: 'DataTable' },
