...
2. L’exposer dans `@theme inline` (`packages/ui/src/styles/index.css`) si un utilitaire Tailwind interne en a besoin.
...
| Lien `link` / `bg`            | ≥ 4.5  | ≥ 4.5  | ≥ 4.5:1                                                       |
| Bordure `border` / `bg`       | 4.76:1 | 3.93:1 | ≥ 3:1 (1.4.11) ; `border-subtle` est décoratif                |
