...
| `PROJECT_TOKEN` | Actions repo          | PAT avec scope `project` pour **En cours** / **En revue** / **Terminé** sur le board org. Sans lui, le job assigne l’issue avec `GITHUB_TOKEN` et tente le board (peut échouer en warning). |
